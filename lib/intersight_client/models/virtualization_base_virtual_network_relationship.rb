...
module IntersightClient
  # A relationship to the 'virtualization.BaseVirtualNetwork' resource, or the expanded 'virtualization.BaseVirtualNetwork' resource, or the 'null' value.
  module VirtualizationBaseVirtualNetworkRelationship
    class << self
