...
module IntersightClient
  # A relationship to the 'compute.PhysicalSummary' resource, or the expanded 'compute.PhysicalSummary' resource, or the 'null' value.
  module ComputePhysicalSummaryRelationship
    class << self
