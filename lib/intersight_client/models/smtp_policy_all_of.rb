  ...
  class SmtpPolicyAllOf
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IntersightClient::SmtpPolicyAllOf` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IntersightClient::SmtpPolicyAllOf`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'class_id')
        ...
        self.class_id = 'smtp.Policy'
      end

      if attributes.key?(:'object_type')
        self.object_type = attributes[:'object_type']
      else
        self.object_type = 'smtp.Policy'
      end
      ...
      if attributes.key?(:'smtp_recipients')
        if (value = attributes[:'smtp_recipients']).is_a?(Array)
          self.smtp_recipients = value
        end
      end
    ...
    def valid?
      ...
      class_id_validator = EnumAttributeValidator.new('String', ["smtp.Policy"])
      return false unless class_id_validator.valid?(@class_id)
      return false if @object_type.nil?
      object_type_validator = EnumAttributeValidator.new('String', ["smtp.Policy"])
    ...
    def class_id=(class_id)
      validator = EnumAttributeValidator.new('String', ["smtp.Policy"])
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] min_severity Object to be assigned
    def min_severity=(min_severity)
      validator = EnumAttributeValidator.new('String', ["critical", "condition", "warning", "minor", "major"])
      unless validator.valid?(min_severity)
        fail ArgumentError, "invalid value for \"min_severity\", must be one of #{validator.allowable_values}."
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          smtp_recipients == o.smtp_recipients &&
    ...
    def hash
      [class_id, object_type, enabled, min_severity, sender_email, smtp_port, smtp_recipients, smtp_server, organization, profiles].hash
    end
    ...
    def build_from_hash(attributes)
      ...
      SmtpPolicyAllOf.openapi_types.each_pair do |key, type|
        if attributes[SmtpPolicyAllOf.attribute_map[key]].nil? && SmtpPolicyAllOf.openapi_nullable.include?(key)
          self.send("#{key}=", nil)
        elsif type =~ /\AArray<(.*)>/i
          # check to ensure the input is an array given that the attribute
          # is documented as an array but the input is not
          if attributes[SmtpPolicyAllOf.attribute_map[key]].is_a?(Array)
            self.send("#{key}=", attributes[SmtpPolicyAllOf.attribute_map[key]].map { |v| _deserialize($1, v) })
          end
        elsif !attributes[SmtpPolicyAllOf.attribute_map[key]].nil?
          self.send("#{key}=", _deserialize(type, attributes[SmtpPolicyAllOf.attribute_map[key]]))
        end
      end
    ...
    def to_hash
      hash = {}
      SmtpPolicyAllOf.attribute_map.each_pair do |attr, param|
        value = self.send(attr)
        if value.nil?
          is_nullable = SmtpPolicyAllOf.openapi_nullable.include?(attr)
