...
module IntersightClient
  # A relationship to the 'workflow.SolutionActionDefinition' resource, or the expanded 'workflow.SolutionActionDefinition' resource, or the 'null' value.
  module WorkflowSolutionActionDefinitionRelationship
    class << self
