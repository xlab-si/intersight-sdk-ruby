...
module IntersightClient
  # Definition of the list of properties defined in 'cloud.Regions', excluding properties defined in parent classes.
  class CloudRegionsAllOf
    ...
    attr_accessor :region_end_point
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IntersightClient::CloudRegionsAllOf` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IntersightClient::CloudRegionsAllOf`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'class_id')
        ...
        self.class_id = 'cloud.Regions'
      end

      if attributes.key?(:'object_type')
        self.object_type = attributes[:'object_type']
      else
        self.object_type = 'cloud.Regions'
      end
      ...
      if attributes.key?(:'default_zone')
        self.default_zone = attributes[:'default_zone']
      end
      ...
      if attributes.key?(:'is_billing_only')
        self.is_billing_only = attributes[:'is_billing_only']
      end
      ...
      if attributes.key?(:'region_end_point')
        self.region_end_point = attributes[:'region_end_point']
      end
    ...
    def valid?
      ...
      class_id_validator = EnumAttributeValidator.new('String', ["cloud.Regions"])
      return false unless class_id_validator.valid?(@class_id)
      return false if @object_type.nil?
      object_type_validator = EnumAttributeValidator.new('String', ["cloud.Regions"])
    ...
    def class_id=(class_id)
      validator = EnumAttributeValidator.new('String', ["cloud.Regions"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          default_zone == o.default_zone &&
          group == o.group &&
          is_active == o.is_active &&
          is_billing_only == o.is_billing_only &&
          name == o.name &&
          platform_type == o.platform_type &&
          region_end_point == o.region_end_point &&
    ...
    def hash
      [class_id, object_type, alternate_names, default_zone, group, is_active, is_billing_only, name, platform_type, region_end_point, region_id, zones, target].hash
    end
    ...
    def build_from_hash(attributes)
      ...
      CloudRegionsAllOf.openapi_types.each_pair do |key, type|
        if attributes[CloudRegionsAllOf.attribute_map[key]].nil? && CloudRegionsAllOf.openapi_nullable.include?(key)
          self.send("#{key}=", nil)
        elsif type =~ /\AArray<(.*)>/i
          # check to ensure the input is an array given that the attribute
          # is documented as an array but the input is not
          if attributes[CloudRegionsAllOf.attribute_map[key]].is_a?(Array)
            self.send("#{key}=", attributes[CloudRegionsAllOf.attribute_map[key]].map { |v| _deserialize($1, v) })
          end
        elsif !attributes[CloudRegionsAllOf.attribute_map[key]].nil?
          self.send("#{key}=", _deserialize(type, attributes[CloudRegionsAllOf.attribute_map[key]]))
        end
      end
    ...
    def to_hash
      hash = {}
      CloudRegionsAllOf.attribute_map.each_pair do |attr, param|
        value = self.send(attr)
        if value.nil?
          is_nullable = CloudRegionsAllOf.openapi_nullable.include?(attr)
