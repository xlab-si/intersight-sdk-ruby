...
module IntersightClient
  # A relationship to the 'firmware.BaseDistributable' resource, or the expanded 'firmware.BaseDistributable' resource, or the 'null' value.
  module FirmwareBaseDistributableRelationship
    class << self
