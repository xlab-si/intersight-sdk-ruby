...
module IntersightClient
  # A relationship to the 'hyperflex.HxapNetwork' resource, or the expanded 'hyperflex.HxapNetwork' resource, or the 'null' value.
  module HyperflexHxapNetworkRelationship
    class << self
