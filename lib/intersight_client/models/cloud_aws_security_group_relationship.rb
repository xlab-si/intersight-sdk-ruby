...
module IntersightClient
  # A relationship to the 'cloud.AwsSecurityGroup' resource, or the expanded 'cloud.AwsSecurityGroup' resource, or the 'null' value.
  module CloudAwsSecurityGroupRelationship
    class << self
