...
module IntersightClient
  # A relationship to the 'hyperflex.SoftwareDistributionVersion' resource, or the expanded 'hyperflex.SoftwareDistributionVersion' resource, or the 'null' value.
  module HyperflexSoftwareDistributionVersionRelationship
    class << self
