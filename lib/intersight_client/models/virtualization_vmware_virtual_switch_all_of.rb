...
module IntersightClient
  # Definition of the list of properties defined in 'virtualization.VmwareVirtualSwitch', excluding properties defined in parent classes.
  class VirtualizationVmwareVirtualSwitchAllOf
    ...
    attr_accessor :num_physical_network_interfaces
    ...
    def self.attribute_map
      {
        ...
        :'num_physical_network_interfaces' => :'NumPhysicalNetworkInterfaces',
    ...
    def self.openapi_types
      {
        ...
        :'num_physical_network_interfaces' => :'Integer',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IntersightClient::VirtualizationVmwareVirtualSwitchAllOf` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IntersightClient::VirtualizationVmwareVirtualSwitchAllOf`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'class_id')
        ...
        self.class_id = 'virtualization.VmwareVirtualSwitch'
      end

      if attributes.key?(:'object_type')
        self.object_type = attributes[:'object_type']
      else
        self.object_type = 'virtualization.VmwareVirtualSwitch'
      end
      ...
      if attributes.key?(:'num_physical_network_interfaces')
        self.num_physical_network_interfaces = attributes[:'num_physical_network_interfaces']
      end
    ...
    def valid?
      ...
      class_id_validator = EnumAttributeValidator.new('String', ["virtualization.VmwareVirtualSwitch"])
      return false unless class_id_validator.valid?(@class_id)
      return false if @object_type.nil?
      object_type_validator = EnumAttributeValidator.new('String', ["virtualization.VmwareVirtualSwitch"])
    ...
    def class_id=(class_id)
      validator = EnumAttributeValidator.new('String', ["virtualization.VmwareVirtualSwitch"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          num_physical_network_interfaces == o.num_physical_network_interfaces &&
    ...
    def hash
      [class_id, object_type, forged_transmits, mac_address_changes, mtu, nic_teaming_and_failover, num_networks, num_physical_network_interfaces, promiscuous_mode, host].hash
    end
    ...
    def build_from_hash(attributes)
      ...
      VirtualizationVmwareVirtualSwitchAllOf.openapi_types.each_pair do |key, type|
        if attributes[VirtualizationVmwareVirtualSwitchAllOf.attribute_map[key]].nil? && VirtualizationVmwareVirtualSwitchAllOf.openapi_nullable.include?(key)
          self.send("#{key}=", nil)
        elsif type =~ /\AArray<(.*)>/i
          # check to ensure the input is an array given that the attribute
          # is documented as an array but the input is not
          if attributes[VirtualizationVmwareVirtualSwitchAllOf.attribute_map[key]].is_a?(Array)
            self.send("#{key}=", attributes[VirtualizationVmwareVirtualSwitchAllOf.attribute_map[key]].map { |v| _deserialize($1, v) })
          end
        elsif !attributes[VirtualizationVmwareVirtualSwitchAllOf.attribute_map[key]].nil?
          self.send("#{key}=", _deserialize(type, attributes[VirtualizationVmwareVirtualSwitchAllOf.attribute_map[key]]))
        end
      end
    ...
    def to_hash
      hash = {}
      VirtualizationVmwareVirtualSwitchAllOf.attribute_map.each_pair do |attr, param|
        value = self.send(attr)
        if value.nil?
          is_nullable = VirtualizationVmwareVirtualSwitchAllOf.openapi_nullable.include?(attr)
