...
module IntersightClient
  # A relationship to the 'workflow.SolutionInstance' resource, or the expanded 'workflow.SolutionInstance' resource, or the 'null' value.
  module WorkflowSolutionInstanceRelationship
    class << self
