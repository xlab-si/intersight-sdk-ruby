...
module IntersightClient
  ...
  class SoftwarerepositoryCachedImage < ConnectorDownloadStatus
    ...
    attr_accessor :original_sha512sum
    ...
    def self.attribute_map
      {
        ...
        :'md5sum' => :'Md5sum',
        :'original_sha512sum' => :'OriginalSha512sum',
        :'path' => :'Path',
    ...
    def self.openapi_types
      {
        ...
        :'md5sum' => :'String',
        :'original_sha512sum' => :'String',
        :'path' => :'String',
        :'registered_workflows' => :'Array<String>',
        :'used_count' => :'Integer',
        :'file' => :'SoftwarerepositoryFileRelationship',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IntersightClient::SoftwarerepositoryCachedImage` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IntersightClient::SoftwarerepositoryCachedImage`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'class_id')
        ...
        self.class_id = 'softwarerepository.CachedImage'
      end

      if attributes.key?(:'object_type')
        self.object_type = attributes[:'object_type']
      else
        self.object_type = 'softwarerepository.CachedImage'
      end
      ...
      if attributes.key?(:'cache_state')
        self.cache_state = attributes[:'cache_state']
      else
        self.cache_state = 'ReadyForImport'
      end

      if attributes.key?(:'cached_time')
        self.cached_time = attributes[:'cached_time']
      end
      ...
      if attributes.key?(:'original_sha512sum')
        self.original_sha512sum = attributes[:'original_sha512sum']
      end
    ...
    def class_id=(class_id)
      validator = EnumAttributeValidator.new('String', ["softwarerepository.CachedImage"])
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] cache_state Object to be assigned
    def cache_state=(cache_state)
      ...
      unless validator.valid?(cache_state)
        fail ArgumentError, "invalid value for \"cache_state\", must be one of #{validator.allowable_values}."
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          file == o.file &&
          network_element == o.network_element && super(o)
    end
    ...
    def build_from_hash(attributes)
      ...
      super(attributes)
      SoftwarerepositoryCachedImage.openapi_types.each_pair do |key, type|
        if attributes[SoftwarerepositoryCachedImage.attribute_map[key]].nil? && SoftwarerepositoryCachedImage.openapi_nullable.include?(key)
          self.send("#{key}=", nil)
        elsif type =~ /\AArray<(.*)>/i
          # check to ensure the input is an array given that the attribute
          # is documented as an array but the input is not
          if attributes[SoftwarerepositoryCachedImage.attribute_map[key]].is_a?(Array)
            self.send("#{key}=", attributes[SoftwarerepositoryCachedImage.attribute_map[key]].map { |v| _deserialize($1, v) })
          end
        elsif !attributes[SoftwarerepositoryCachedImage.attribute_map[key]].nil?
          self.send("#{key}=", _deserialize(type, attributes[SoftwarerepositoryCachedImage.attribute_map[key]]))
        end
      end
    ...
    def to_hash
      hash = super
      SoftwarerepositoryCachedImage.attribute_map.each_pair do |attr, param|
        value = self.send(attr)
        if value.nil?
          is_nullable = SoftwarerepositoryCachedImage.openapi_nullable.include?(attr)
