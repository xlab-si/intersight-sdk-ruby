...
module IntersightClient
  ...
  class GraphicsCardAllOf
    ...
    attr_accessor :pci_address_list
    ...
    attr_accessor :graphics_controllers
    ...
    def self.openapi_types
      {
        ...
        :'card_id' => :'Integer',
        :'device_id' => :'Integer',
        :'expander_slot' => :'String',
        :'firmware_version' => :'String',
        :'mode' => :'String',
        :'num_gpus' => :'String',
        :'oper_state' => :'String',
        :'pci_address' => :'String',
        :'pci_address_list' => :'String',
        :'pci_slot' => :'String',
        ...
        :'graphics_controllers' => :'Array<GraphicsControllerRelationship>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IntersightClient::GraphicsCardAllOf` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IntersightClient::GraphicsCardAllOf`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'class_id')
        ...
        self.class_id = 'graphics.Card'
      end

      if attributes.key?(:'object_type')
        self.object_type = attributes[:'object_type']
      else
        self.object_type = 'graphics.Card'
      end
      ...
      if attributes.key?(:'expander_slot')
        self.expander_slot = attributes[:'expander_slot']
      end
      ...
      if attributes.key?(:'num_gpus')
        self.num_gpus = attributes[:'num_gpus']
      end
      ...
      if attributes.key?(:'pci_address_list')
        self.pci_address_list = attributes[:'pci_address_list']
      end
      ...
      if attributes.key?(:'graphics_controllers')
        if (value = attributes[:'graphics_controllers']).is_a?(Array)
          self.graphics_controllers = value
        end
      end
    ...
    def valid?
      ...
      class_id_validator = EnumAttributeValidator.new('String', ["graphics.Card"])
      return false unless class_id_validator.valid?(@class_id)
      return false if @object_type.nil?
      object_type_validator = EnumAttributeValidator.new('String', ["graphics.Card"])
    ...
    def class_id=(class_id)
      validator = EnumAttributeValidator.new('String', ["graphics.Card"])
    ...
    def hash
      [class_id, object_type, card_id, device_id, expander_slot, firmware_version, mode, num_gpus, oper_state, pci_address, pci_address_list, pci_slot, compute_blade, compute_board, compute_rack_unit, graphics_controllers, inventory_device_info, registered_device, running_firmware].hash
    end
    ...
    def build_from_hash(attributes)
      ...
      GraphicsCardAllOf.openapi_types.each_pair do |key, type|
        if attributes[GraphicsCardAllOf.attribute_map[key]].nil? && GraphicsCardAllOf.openapi_nullable.include?(key)
          self.send("#{key}=", nil)
        elsif type =~ /\AArray<(.*)>/i
          # check to ensure the input is an array given that the attribute
          # is documented as an array but the input is not
          if attributes[GraphicsCardAllOf.attribute_map[key]].is_a?(Array)
            self.send("#{key}=", attributes[GraphicsCardAllOf.attribute_map[key]].map { |v| _deserialize($1, v) })
          end
        elsif !attributes[GraphicsCardAllOf.attribute_map[key]].nil?
          self.send("#{key}=", _deserialize(type, attributes[GraphicsCardAllOf.attribute_map[key]]))
        end
      end
    ...
    def to_hash
      hash = {}
      GraphicsCardAllOf.attribute_map.each_pair do |attr, param|
        value = self.send(attr)
        if value.nil?
          is_nullable = GraphicsCardAllOf.openapi_nullable.include?(attr)
