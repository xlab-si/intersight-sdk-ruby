...
module IntersightClient
  # A relationship to the 'kubernetes.ClusterAddonProfile' resource, or the expanded 'kubernetes.ClusterAddonProfile' resource, or the 'null' value.
  module KubernetesClusterAddonProfileRelationship
    class << self
