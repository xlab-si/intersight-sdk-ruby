...
module IntersightClient
  # A relationship to the 'hyperflex.SoftwareDistributionComponent' resource, or the expanded 'hyperflex.SoftwareDistributionComponent' resource, or the 'null' value.
  module HyperflexSoftwareDistributionComponentRelationship
    class << self
