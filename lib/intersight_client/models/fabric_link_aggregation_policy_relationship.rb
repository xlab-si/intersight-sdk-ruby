...
module IntersightClient
  # A relationship to the 'fabric.LinkAggregationPolicy' resource, or the expanded 'fabric.LinkAggregationPolicy' resource, or the 'null' value.
  module FabricLinkAggregationPolicyRelationship
    class << self
