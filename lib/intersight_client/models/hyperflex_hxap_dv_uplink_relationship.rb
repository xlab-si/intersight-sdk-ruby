...
module IntersightClient
  # A relationship to the 'hyperflex.HxapDvUplink' resource, or the expanded 'hyperflex.HxapDvUplink' resource, or the 'null' value.
  module HyperflexHxapDvUplinkRelationship
    class << self
