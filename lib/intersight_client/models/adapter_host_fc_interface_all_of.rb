...
module IntersightClient
  ...
  class AdapterHostFcInterfaceAllOf
    ...
    attr_accessor :host_fc_interface_id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IntersightClient::AdapterHostFcInterfaceAllOf` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IntersightClient::AdapterHostFcInterfaceAllOf`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'class_id')
        ...
        self.class_id = 'adapter.HostFcInterface'
      end

      if attributes.key?(:'object_type')
        self.object_type = attributes[:'object_type']
      else
        self.object_type = 'adapter.HostFcInterface'
      end
      ...
      if attributes.key?(:'host_fc_interface_id')
        self.host_fc_interface_id = attributes[:'host_fc_interface_id']
      end
      ...
      if attributes.key?(:'original_wwnn')
        self.original_wwnn = attributes[:'original_wwnn']
      end

      if attributes.key?(:'original_wwpn')
        self.original_wwpn = attributes[:'original_wwpn']
      end
      ...
      if attributes.key?(:'wwnn')
        self.wwnn = attributes[:'wwnn']
      end
    ...
    def valid?
      ...
      class_id_validator = EnumAttributeValidator.new('String', ["adapter.HostFcInterface"])
      return false unless class_id_validator.valid?(@class_id)
      return false if @object_type.nil?
      object_type_validator = EnumAttributeValidator.new('String', ["adapter.HostFcInterface"])
    ...
    def class_id=(class_id)
      validator = EnumAttributeValidator.new('String', ["adapter.HostFcInterface"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          ep_dn == o.ep_dn &&
          host_fc_interface_id == o.host_fc_interface_id &&
          name == o.name &&
          oper_reason == o.oper_reason &&
          oper_state == o.oper_state &&
          operability == o.operability &&
          original_wwnn == o.original_wwnn &&
          original_wwpn == o.original_wwpn &&
          peer_dn == o.peer_dn &&
          wwnn == o.wwnn &&
          wwpn == o.wwpn &&
    ...
    def hash
      [class_id, object_type, admin_state, ep_dn, host_fc_interface_id, name, oper_reason, oper_state, operability, original_wwnn, original_wwpn, peer_dn, wwnn, wwpn, adapter_unit, inventory_device_info, registered_device].hash
    end
    ...
    def build_from_hash(attributes)
      ...
      AdapterHostFcInterfaceAllOf.openapi_types.each_pair do |key, type|
        if attributes[AdapterHostFcInterfaceAllOf.attribute_map[key]].nil? && AdapterHostFcInterfaceAllOf.openapi_nullable.include?(key)
          self.send("#{key}=", nil)
        elsif type =~ /\AArray<(.*)>/i
          # check to ensure the input is an array given that the attribute
          # is documented as an array but the input is not
          if attributes[AdapterHostFcInterfaceAllOf.attribute_map[key]].is_a?(Array)
            self.send("#{key}=", attributes[AdapterHostFcInterfaceAllOf.attribute_map[key]].map { |v| _deserialize($1, v) })
          end
        elsif !attributes[AdapterHostFcInterfaceAllOf.attribute_map[key]].nil?
          self.send("#{key}=", _deserialize(type, attributes[AdapterHostFcInterfaceAllOf.attribute_map[key]]))
        end
      end
    ...
    def to_hash
      hash = {}
      AdapterHostFcInterfaceAllOf.attribute_map.each_pair do |attr, param|
        value = self.send(attr)
        if value.nil?
          is_nullable = AdapterHostFcInterfaceAllOf.openapi_nullable.include?(attr)
