...
module IntersightClient
  # A relationship to the 'virtualization.VmwareVirtualSwitch' resource, or the expanded 'virtualization.VmwareVirtualSwitch' resource, or the 'null' value.
  module VirtualizationVmwareVirtualSwitchRelationship
    class << self
