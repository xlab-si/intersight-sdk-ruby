...
module IntersightClient
  # A relationship to the 'convergedinfra.HealthCheckDefinition' resource, or the expanded 'convergedinfra.HealthCheckDefinition' resource, or the 'null' value.
  module ConvergedinfraHealthCheckDefinitionRelationship
    class << self
