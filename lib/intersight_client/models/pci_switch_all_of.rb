...
module IntersightClient
  ...
  class PciSwitchAllOf
    ...
    attr_accessor :sub_device_id

    # The sub vendor id of the switch.
    attr_accessor :sub_vendor_id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IntersightClient::PciSwitchAllOf` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IntersightClient::PciSwitchAllOf`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'class_id')
        ...
        self.class_id = 'pci.Switch'
      end

      if attributes.key?(:'object_type')
        self.object_type = attributes[:'object_type']
      else
        self.object_type = 'pci.Switch'
      end
      ...
      if attributes.key?(:'num_of_adaptors')
        self.num_of_adaptors = attributes[:'num_of_adaptors']
      end
      ...
      if attributes.key?(:'sub_device_id')
        self.sub_device_id = attributes[:'sub_device_id']
      end

      if attributes.key?(:'sub_vendor_id')
        self.sub_vendor_id = attributes[:'sub_vendor_id']
      end
    ...
    def valid?
      ...
      class_id_validator = EnumAttributeValidator.new('String', ["pci.Switch"])
      return false unless class_id_validator.valid?(@class_id)
      return false if @object_type.nil?
      object_type_validator = EnumAttributeValidator.new('String', ["pci.Switch"])
    ...
    def class_id=(class_id)
      validator = EnumAttributeValidator.new('String', ["pci.Switch"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          health == o.health &&
          num_of_adaptors == o.num_of_adaptors &&
          pci_address == o.pci_address &&
          pci_slot == o.pci_slot &&
          product_name == o.product_name &&
          product_revision == o.product_revision &&
          sub_device_id == o.sub_device_id &&
          sub_vendor_id == o.sub_vendor_id &&
    ...
    def hash
      [class_id, object_type, device_id, health, num_of_adaptors, pci_address, pci_slot, product_name, product_revision, sub_device_id, sub_vendor_id, temperature, type, vendor_id, compute_board, inventory_device_info, links, registered_device, running_firmware].hash
    end
    ...
    def build_from_hash(attributes)
      ...
      PciSwitchAllOf.openapi_types.each_pair do |key, type|
        if attributes[PciSwitchAllOf.attribute_map[key]].nil? && PciSwitchAllOf.openapi_nullable.include?(key)
          self.send("#{key}=", nil)
        elsif type =~ /\AArray<(.*)>/i
          # check to ensure the input is an array given that the attribute
          # is documented as an array but the input is not
          if attributes[PciSwitchAllOf.attribute_map[key]].is_a?(Array)
            self.send("#{key}=", attributes[PciSwitchAllOf.attribute_map[key]].map { |v| _deserialize($1, v) })
          end
        elsif !attributes[PciSwitchAllOf.attribute_map[key]].nil?
          self.send("#{key}=", _deserialize(type, attributes[PciSwitchAllOf.attribute_map[key]]))
        end
      end
    ...
    def to_hash
      hash = {}
      PciSwitchAllOf.attribute_map.each_pair do |attr, param|
        value = self.send(attr)
        if value.nil?
          is_nullable = PciSwitchAllOf.openapi_nullable.include?(attr)
