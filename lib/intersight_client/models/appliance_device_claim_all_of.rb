...
module IntersightClient
  ...
  class ApplianceDeviceClaimAllOf
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IntersightClient::ApplianceDeviceClaimAllOf` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IntersightClient::ApplianceDeviceClaimAllOf`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'class_id')
        ...
        self.class_id = 'appliance.DeviceClaim'
      end

      if attributes.key?(:'object_type')
        self.object_type = attributes[:'object_type']
      else
        self.object_type = 'appliance.DeviceClaim'
      end
      ...
      if attributes.key?(:'is_renew')
        self.is_renew = attributes[:'is_renew']
      else
        self.is_renew = false
      end
    ...
    def valid?
      ...
      class_id_validator = EnumAttributeValidator.new('String', ["appliance.DeviceClaim"])
      return false unless class_id_validator.valid?(@class_id)
      return false if @object_type.nil?
      object_type_validator = EnumAttributeValidator.new('String', ["appliance.DeviceClaim"])
      ...
      status_validator = EnumAttributeValidator.new('String', ["started", "failed", "completed"])
    ...
    def class_id=(class_id)
      validator = EnumAttributeValidator.new('String', ["appliance.DeviceClaim"])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ["started", "failed", "completed"])
    ...
    def hash
      [class_id, object_type, device_id, hostname, is_password_set, is_renew, message, password, platform_type, request_id, security_token, status, username, account, reservation].hash
    end
    ...
    def build_from_hash(attributes)
      ...
      ApplianceDeviceClaimAllOf.openapi_types.each_pair do |key, type|
        if attributes[ApplianceDeviceClaimAllOf.attribute_map[key]].nil? && ApplianceDeviceClaimAllOf.openapi_nullable.include?(key)
          self.send("#{key}=", nil)
        elsif type =~ /\AArray<(.*)>/i
          # check to ensure the input is an array given that the attribute
          # is documented as an array but the input is not
          if attributes[ApplianceDeviceClaimAllOf.attribute_map[key]].is_a?(Array)
            self.send("#{key}=", attributes[ApplianceDeviceClaimAllOf.attribute_map[key]].map { |v| _deserialize($1, v) })
          end
        elsif !attributes[ApplianceDeviceClaimAllOf.attribute_map[key]].nil?
          self.send("#{key}=", _deserialize(type, attributes[ApplianceDeviceClaimAllOf.attribute_map[key]]))
        end
      end
    ...
    def to_hash
      hash = {}
      ApplianceDeviceClaimAllOf.attribute_map.each_pair do |attr, param|
        value = self.send(attr)
        if value.nil?
          is_nullable = ApplianceDeviceClaimAllOf.openapi_nullable.include?(attr)
