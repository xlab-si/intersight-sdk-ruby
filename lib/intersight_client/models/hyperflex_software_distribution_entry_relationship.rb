...
module IntersightClient
  # A relationship to the 'hyperflex.SoftwareDistributionEntry' resource, or the expanded 'hyperflex.SoftwareDistributionEntry' resource, or the 'null' value.
  module HyperflexSoftwareDistributionEntryRelationship
    class << self
