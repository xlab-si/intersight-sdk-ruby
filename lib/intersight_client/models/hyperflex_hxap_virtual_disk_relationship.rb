...
module IntersightClient
  # A relationship to the 'hyperflex.HxapVirtualDisk' resource, or the expanded 'hyperflex.HxapVirtualDisk' resource, or the 'null' value.
  module HyperflexHxapVirtualDiskRelationship
    class << self
