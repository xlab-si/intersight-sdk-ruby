...
module IntersightClient
  # A relationship to the 'cloud.AwsBillingUnit' resource, or the expanded 'cloud.AwsBillingUnit' resource, or the 'null' value.
  module CloudAwsBillingUnitRelationship
    class << self
