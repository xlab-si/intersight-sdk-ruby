...
module IntersightClient
  # A relationship to the 'hyperflex.DatastoreStatistic' resource, or the expanded 'hyperflex.DatastoreStatistic' resource, or the 'null' value.
  module HyperflexDatastoreStatisticRelationship
    class << self
