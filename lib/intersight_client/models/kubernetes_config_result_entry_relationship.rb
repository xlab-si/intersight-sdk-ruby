...
module IntersightClient
  # A relationship to the 'kubernetes.ConfigResultEntry' resource, or the expanded 'kubernetes.ConfigResultEntry' resource, or the 'null' value.
  module KubernetesConfigResultEntryRelationship
    class << self
