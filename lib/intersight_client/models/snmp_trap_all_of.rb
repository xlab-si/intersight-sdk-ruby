  ...
  class SnmpTrapAllOf
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IntersightClient::SnmpTrapAllOf` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IntersightClient::SnmpTrapAllOf`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'class_id')
        ...
        self.class_id = 'snmp.Trap'
      end

      if attributes.key?(:'object_type')
        self.object_type = attributes[:'object_type']
      else
        self.object_type = 'snmp.Trap'
      end
    ...
    def list_invalid_properties
      ...
      if !@community.nil? && @community.to_s.length > 18
        invalid_properties.push('invalid value for "community", the character length must be smaller than or equal to 18.')
      end
    ...
    def valid?
      ...
      class_id_validator = EnumAttributeValidator.new('String', ["snmp.Trap"])
      return false unless class_id_validator.valid?(@class_id)
      return false if @object_type.nil?
      object_type_validator = EnumAttributeValidator.new('String', ["snmp.Trap"])
      return false unless object_type_validator.valid?(@object_type)
      return false if !@community.nil? && @community.to_s.length > 18
      return false if !@port.nil? && @port > 65535
      return false if !@port.nil? && @port < 1
      type_validator = EnumAttributeValidator.new('String', ["Trap", "Inform"])
      return false unless type_validator.valid?(@type)
      version_validator = EnumAttributeValidator.new('String', ["V3", "V2"])
    ...
    def class_id=(class_id)
      validator = EnumAttributeValidator.new('String', ["snmp.Trap"])
    ...
    def community=(community)
      if !community.nil? && community.to_s.length > 18
        fail ArgumentError, 'invalid value for "community", the character length must be smaller than or equal to 18.'
      end
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["Trap", "Inform"])
    ...
    def version=(version)
      validator = EnumAttributeValidator.new('String', ["V3", "V2"])
    ...
    def hash
      [class_id, object_type, community, destination, enabled, port, type, user, version].hash
    end
    ...
    def build_from_hash(attributes)
      ...
      SnmpTrapAllOf.openapi_types.each_pair do |key, type|
        if attributes[SnmpTrapAllOf.attribute_map[key]].nil? && SnmpTrapAllOf.openapi_nullable.include?(key)
          self.send("#{key}=", nil)
        elsif type =~ /\AArray<(.*)>/i
          # check to ensure the input is an array given that the attribute
          # is documented as an array but the input is not
          if attributes[SnmpTrapAllOf.attribute_map[key]].is_a?(Array)
            self.send("#{key}=", attributes[SnmpTrapAllOf.attribute_map[key]].map { |v| _deserialize($1, v) })
          end
        elsif !attributes[SnmpTrapAllOf.attribute_map[key]].nil?
          self.send("#{key}=", _deserialize(type, attributes[SnmpTrapAllOf.attribute_map[key]]))
        end
      end
    ...
    def to_hash
      hash = {}
      SnmpTrapAllOf.attribute_map.each_pair do |attr, param|
        value = self.send(attr)
        if value.nil?
          is_nullable = SnmpTrapAllOf.openapi_nullable.include?(attr)
