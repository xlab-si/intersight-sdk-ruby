...
module IntersightClient
  # A relationship to the 'kubernetes.VirtualMachineInfraConfigPolicy' resource, or the expanded 'kubernetes.VirtualMachineInfraConfigPolicy' resource, or the 'null' value.
  module KubernetesVirtualMachineInfraConfigPolicyRelationship
    class << self
