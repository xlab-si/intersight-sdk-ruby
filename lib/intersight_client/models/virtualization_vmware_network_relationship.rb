...
module IntersightClient
  # A relationship to the 'virtualization.VmwareNetwork' resource, or the expanded 'virtualization.VmwareNetwork' resource, or the 'null' value.
  module VirtualizationVmwareNetworkRelationship
    class << self
