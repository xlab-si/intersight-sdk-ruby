...
module IntersightClient
  # Definition of the list of properties defined in 'hyperflex.Drive', excluding properties defined in parent classes.
  class HyperflexDriveAllOf
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IntersightClient::HyperflexDriveAllOf` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IntersightClient::HyperflexDriveAllOf`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'class_id')
        ...
        self.class_id = 'hyperflex.Drive'
      end

      if attributes.key?(:'object_type')
        self.object_type = attributes[:'object_type']
      else
        self.object_type = 'hyperflex.Drive'
      end
      ...
      if attributes.key?(:'disk_use_state')
        self.disk_use_state = attributes[:'disk_use_state']
      else
        self.disk_use_state = 'UNKNOWN'
      end
    ...
    def valid?
      ...
      class_id_validator = EnumAttributeValidator.new('String', ["hyperflex.Drive"])
      return false unless class_id_validator.valid?(@class_id)
      return false if @object_type.nil?
      object_type_validator = EnumAttributeValidator.new('String', ["hyperflex.Drive"])
      return false unless object_type_validator.valid?(@object_type)
      disk_use_state_validator = EnumAttributeValidator.new('String', ["UNKNOWN", "USED", "NOTUSED", "EMPTY"])
      return false unless disk_use_state_validator.valid?(@disk_use_state)
      ...
      status_validator = EnumAttributeValidator.new('String', ["UNKNOWN", "CLAIMED", "AVAILABLE", "IGNORED", "BLACKLISTED", "SECUREERASED"])
      ...
      usage_validator = EnumAttributeValidator.new('String', ["UNKNOWN", "PERSISTENCE", "SYSTEM", "CACHING"])
    ...
    def class_id=(class_id)
      validator = EnumAttributeValidator.new('String', ["hyperflex.Drive"])
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] disk_use_state Object to be assigned
    def disk_use_state=(disk_use_state)
      validator = EnumAttributeValidator.new('String', ["UNKNOWN", "USED", "NOTUSED", "EMPTY"])
      unless validator.valid?(disk_use_state)
        fail ArgumentError, "invalid value for \"disk_use_state\", must be one of #{validator.allowable_values}."
      end
      @disk_use_state = disk_use_state
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] protocol Object to be assigned
    def protocol=(protocol)
      validator = EnumAttributeValidator.new('String', ["Unknown", "SAS", "NVMe", "SATA"])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ["UNKNOWN", "CLAIMED", "AVAILABLE", "IGNORED", "BLACKLISTED", "SECUREERASED"])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["Unknown", "SSD", "HDD", "NVRAM", "SATA", "BSAS", "FC", "FSAS", "LUN", "MSATA", "SAS", "VMDISK"])
    ...
    def usage=(usage)
      validator = EnumAttributeValidator.new('String', ["UNKNOWN", "PERSISTENCE", "SYSTEM", "CACHING"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          capacity == o.capacity &&
          disk_use_state == o.disk_use_state &&
    ...
    def hash
      [class_id, object_type, capacity, disk_use_state, host_name, host_uuid, model_number, node_uuid, path, protocol, serial_number, slot_number, status, type, usage, used_capacity, uuid, version, locator_led, node].hash
    end
    ...
    def build_from_hash(attributes)
      ...
      HyperflexDriveAllOf.openapi_types.each_pair do |key, type|
        if attributes[HyperflexDriveAllOf.attribute_map[key]].nil? && HyperflexDriveAllOf.openapi_nullable.include?(key)
          self.send("#{key}=", nil)
        elsif type =~ /\AArray<(.*)>/i
          # check to ensure the input is an array given that the attribute
          # is documented as an array but the input is not
          if attributes[HyperflexDriveAllOf.attribute_map[key]].is_a?(Array)
            self.send("#{key}=", attributes[HyperflexDriveAllOf.attribute_map[key]].map { |v| _deserialize($1, v) })
          end
        elsif !attributes[HyperflexDriveAllOf.attribute_map[key]].nil?
          self.send("#{key}=", _deserialize(type, attributes[HyperflexDriveAllOf.attribute_map[key]]))
        end
      end
    ...
    def to_hash
      hash = {}
      HyperflexDriveAllOf.attribute_map.each_pair do |attr, param|
        value = self.send(attr)
        if value.nil?
          is_nullable = HyperflexDriveAllOf.openapi_nullable.include?(attr)
