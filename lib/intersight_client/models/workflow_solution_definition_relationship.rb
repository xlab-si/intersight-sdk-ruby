...
module IntersightClient
  # A relationship to the 'workflow.SolutionDefinition' resource, or the expanded 'workflow.SolutionDefinition' resource, or the 'null' value.
  module WorkflowSolutionDefinitionRelationship
    class << self
