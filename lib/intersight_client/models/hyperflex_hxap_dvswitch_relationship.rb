...
module IntersightClient
  # A relationship to the 'hyperflex.HxapDvswitch' resource, or the expanded 'hyperflex.HxapDvswitch' resource, or the 'null' value.
  module HyperflexHxapDvswitchRelationship
    class << self
