...
module IntersightClient
  # A relationship to the 'fabric.FlowControlPolicy' resource, or the expanded 'fabric.FlowControlPolicy' resource, or the 'null' value.
  module FabricFlowControlPolicyRelationship
    class << self
