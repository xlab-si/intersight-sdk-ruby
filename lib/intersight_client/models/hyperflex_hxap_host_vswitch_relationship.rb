...
module IntersightClient
  # A relationship to the 'hyperflex.HxapHostVswitch' resource, or the expanded 'hyperflex.HxapHostVswitch' resource, or the 'null' value.
  module HyperflexHxapHostVswitchRelationship
    class << self
