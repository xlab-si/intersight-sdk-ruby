...
module IntersightClient
  # A relationship to the 'kubernetes.ConfigResult' resource, or the expanded 'kubernetes.ConfigResult' resource, or the 'null' value.
  module KubernetesConfigResultRelationship
    class << self
