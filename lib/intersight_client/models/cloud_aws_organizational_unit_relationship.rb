...
module IntersightClient
  # A relationship to the 'cloud.AwsOrganizationalUnit' resource, or the expanded 'cloud.AwsOrganizationalUnit' resource, or the 'null' value.
  module CloudAwsOrganizationalUnitRelationship
    class << self
