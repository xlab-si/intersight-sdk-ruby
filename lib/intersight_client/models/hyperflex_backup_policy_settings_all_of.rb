...
module IntersightClient
  # Definition of the list of properties defined in 'hyperflex.BackupPolicySettings', excluding properties defined in parent classes.
  class HyperflexBackupPolicySettingsAllOf
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IntersightClient::HyperflexBackupPolicySettingsAllOf` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IntersightClient::HyperflexBackupPolicySettingsAllOf`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'class_id')
        ...
        self.class_id = 'hyperflex.BackupPolicySettings'
      end

      if attributes.key?(:'object_type')
        self.object_type = attributes[:'object_type']
      else
        self.object_type = 'hyperflex.BackupPolicySettings'
      end
      ...
      if attributes.key?(:'backup_data_store_size_unit')
        ...
        self.backup_data_store_size_unit = 'GB'
      end
    ...
    def valid?
      ...
      class_id_validator = EnumAttributeValidator.new('String', ["hyperflex.BackupPolicySettings"])
      return false unless class_id_validator.valid?(@class_id)
      return false if @object_type.nil?
      object_type_validator = EnumAttributeValidator.new('String', ["hyperflex.BackupPolicySettings"])
      return false unless object_type_validator.valid?(@object_type)
      backup_data_store_size_unit_validator = EnumAttributeValidator.new('String', ["GB", "TB"])
      return false unless backup_data_store_size_unit_validator.valid?(@backup_data_store_size_unit)
      true
    end
    ...
    def class_id=(class_id)
      validator = EnumAttributeValidator.new('String', ["hyperflex.BackupPolicySettings"])
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] backup_data_store_size_unit Object to be assigned
    def backup_data_store_size_unit=(backup_data_store_size_unit)
      validator = EnumAttributeValidator.new('String', ["GB", "TB"])
      unless validator.valid?(backup_data_store_size_unit)
        fail ArgumentError, "invalid value for \"backup_data_store_size_unit\", must be one of #{validator.allowable_values}."
      end
      @backup_data_store_size_unit = backup_data_store_size_unit
    end
    ...
    def hash
      [class_id, object_type, backup_data_store_name, backup_data_store_size, backup_data_store_size_unit, data_store_encryption_enabled, local_snapshot_retention_count, replication_interval_in_minutes, replication_pair_name_prefix, snapshot_retention_count].hash
    end
    ...
    def build_from_hash(attributes)
      ...
      HyperflexBackupPolicySettingsAllOf.openapi_types.each_pair do |key, type|
        if attributes[HyperflexBackupPolicySettingsAllOf.attribute_map[key]].nil? && HyperflexBackupPolicySettingsAllOf.openapi_nullable.include?(key)
          self.send("#{key}=", nil)
        elsif type =~ /\AArray<(.*)>/i
          # check to ensure the input is an array given that the attribute
          # is documented as an array but the input is not
          if attributes[HyperflexBackupPolicySettingsAllOf.attribute_map[key]].is_a?(Array)
            self.send("#{key}=", attributes[HyperflexBackupPolicySettingsAllOf.attribute_map[key]].map { |v| _deserialize($1, v) })
          end
        elsif !attributes[HyperflexBackupPolicySettingsAllOf.attribute_map[key]].nil?
          self.send("#{key}=", _deserialize(type, attributes[HyperflexBackupPolicySettingsAllOf.attribute_map[key]]))
        end
      end
    ...
    def to_hash
      hash = {}
      HyperflexBackupPolicySettingsAllOf.attribute_map.each_pair do |attr, param|
        value = self.send(attr)
        if value.nil?
          is_nullable = HyperflexBackupPolicySettingsAllOf.openapi_nullable.include?(attr)
