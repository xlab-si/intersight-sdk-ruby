  ...
  class VirtualizationHostAllOf
    ...
    def self.openapi_types
      {
        ...
        :'serial' => :'String',
        :'vendor' => :'String',
        :'inventory' => :'VirtualizationBaseHostRelationship',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IntersightClient::VirtualizationHostAllOf` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IntersightClient::VirtualizationHostAllOf`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'class_id')
        ...
        self.class_id = 'virtualization.Host'
      end

      if attributes.key?(:'object_type')
        self.object_type = attributes[:'object_type']
      else
        self.object_type = 'virtualization.Host'
      end
    ...
    def valid?
      ...
      class_id_validator = EnumAttributeValidator.new('String', ["virtualization.Host"])
      return false unless class_id_validator.valid?(@class_id)
      return false if @object_type.nil?
      object_type_validator = EnumAttributeValidator.new('String', ["virtualization.Host"])
      return false unless object_type_validator.valid?(@object_type)
      action_validator = EnumAttributeValidator.new('String', ["None", "PowerOffStorageController", "PowerOnStorageController"])
    ...
    def class_id=(class_id)
      validator = EnumAttributeValidator.new('String', ["virtualization.Host"])
    ...
    def action=(action)
      validator = EnumAttributeValidator.new('String', ["None", "PowerOffStorageController", "PowerOnStorageController"])
    ...
    def hash
      [class_id, object_type, action, hypervisor_type, identity, model, name, serial, vendor, inventory, registered_device, workflow_info].hash
    end
    ...
    def build_from_hash(attributes)
      ...
      VirtualizationHostAllOf.openapi_types.each_pair do |key, type|
        if attributes[VirtualizationHostAllOf.attribute_map[key]].nil? && VirtualizationHostAllOf.openapi_nullable.include?(key)
          self.send("#{key}=", nil)
        elsif type =~ /\AArray<(.*)>/i
          # check to ensure the input is an array given that the attribute
          # is documented as an array but the input is not
          if attributes[VirtualizationHostAllOf.attribute_map[key]].is_a?(Array)
            self.send("#{key}=", attributes[VirtualizationHostAllOf.attribute_map[key]].map { |v| _deserialize($1, v) })
          end
        elsif !attributes[VirtualizationHostAllOf.attribute_map[key]].nil?
          self.send("#{key}=", _deserialize(type, attributes[VirtualizationHostAllOf.attribute_map[key]]))
        end
      end
    ...
    def to_hash
      hash = {}
      VirtualizationHostAllOf.attribute_map.each_pair do |attr, param|
        value = self.send(attr)
        if value.nil?
          is_nullable = VirtualizationHostAllOf.openapi_nullable.include?(attr)
