...
module IntersightClient
  ...
  class EquipmentIoCardBaseAllOf
    ...
    def self.openapi_types
      {
        ...
        :'version' => :'String',
        :'vid' => :'String',
        :'host_ports' => :'Array<EtherHostPortRelationship>',
        :'mgmt_controller' => :'ManagementControllerRelationship',
        :'network_ports' => :'Array<EtherNetworkPortRelationship>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IntersightClient::EquipmentIoCardBaseAllOf` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IntersightClient::EquipmentIoCardBaseAllOf`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'mgmt_controller')
        self.mgmt_controller = attributes[:'mgmt_controller']
      end
    ...
    def valid?
      ...
      class_id_validator = EnumAttributeValidator.new('String', ["equipment.Fex", "equipment.IoCard"])
      return false unless class_id_validator.valid?(@class_id)
      return false if @object_type.nil?
      object_type_validator = EnumAttributeValidator.new('String', ["equipment.Fex", "equipment.IoCard"])
    ...
    def class_id=(class_id)
      validator = EnumAttributeValidator.new('String', ["equipment.Fex", "equipment.IoCard"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          mgmt_controller == o.mgmt_controller &&
    ...
    def hash
      [class_id, object_type, connection_status, description, module_id, oper_reason, oper_state, part_number, pid, product_name, sku, version, vid, host_ports, mgmt_controller, network_ports].hash
    end
    ...
    def build_from_hash(attributes)
      ...
      EquipmentIoCardBaseAllOf.openapi_types.each_pair do |key, type|
        if attributes[EquipmentIoCardBaseAllOf.attribute_map[key]].nil? && EquipmentIoCardBaseAllOf.openapi_nullable.include?(key)
          self.send("#{key}=", nil)
        elsif type =~ /\AArray<(.*)>/i
          # check to ensure the input is an array given that the attribute
          # is documented as an array but the input is not
          if attributes[EquipmentIoCardBaseAllOf.attribute_map[key]].is_a?(Array)
            self.send("#{key}=", attributes[EquipmentIoCardBaseAllOf.attribute_map[key]].map { |v| _deserialize($1, v) })
          end
        elsif !attributes[EquipmentIoCardBaseAllOf.attribute_map[key]].nil?
          self.send("#{key}=", _deserialize(type, attributes[EquipmentIoCardBaseAllOf.attribute_map[key]]))
        end
      end
    ...
    def to_hash
      hash = {}
      EquipmentIoCardBaseAllOf.attribute_map.each_pair do |attr, param|
        value = self.send(attr)
        if value.nil?
          is_nullable = EquipmentIoCardBaseAllOf.openapi_nullable.include?(attr)
