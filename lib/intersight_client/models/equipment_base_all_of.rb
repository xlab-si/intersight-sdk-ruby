  ...
  class EquipmentBaseAllOf
    ...
    def self.openapi_types
      {
        ...
        :'serial' => :'String',
        :'vendor' => :'String',
        :'previous_fru' => :'EquipmentFruRelationship'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IntersightClient::EquipmentBaseAllOf` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IntersightClient::EquipmentBaseAllOf`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'previous_fru')
        self.previous_fru = attributes[:'previous_fru']
      end
    end
    ...
    def class_id=(class_id)
      validator = EnumAttributeValidator.new('String', ["adapter.HostFcInterface", "adapter.HostIscsiInterface", "adapter.Unit", "adapter.UnitExpander", "bios.Unit", "boot.CddDevice", "boot.HddDevice", "boot.IscsiDevice", "boot.NvmeDevice", "boot.PchStorageDevice", "boot.PxeDevice", "boot.SanDevice", "boot.SdDevice", "boot.UefiShellDevice", "boot.UsbDevice", "boot.VmediaDevice", "compute.Blade", "compute.Board", "compute.RackUnit", "equipment.Chassis", "equipment.ExpanderModule", "equipment.Fan", "equipment.FanControl", "equipment.FanModule", "equipment.Fex", "equipment.Fru", "equipment.IoCard", "equipment.IoExpander", "equipment.Psu", "equipment.PsuControl", "equipment.RackEnclosure", "equipment.RackEnclosureSlot", "equipment.SharedIoModule", "equipment.SwitchCard", "equipment.SystemIoController", "equipment.Tpm", "equipment.Transceiver", "graphics.Card", "graphics.Controller", "memory.Array", "memory.PersistentMemoryUnit", "memory.Unit", "network.Element", "pci.CoprocessorCard", "pci.Device", "pci.Link", "pci.Switch", "processor.Unit", "security.Unit", "storage.Controller", "storage.DiskSlot", "storage.Enclosure", "storage.EnclosureDisk", "storage.FlexFlashController", "storage.FlexFlashControllerProps", "storage.FlexFlashPhysicalDrive", "storage.FlexFlashVirtualDrive", "storage.FlexUtilPhysicalDrive", "storage.HitachiArray", "storage.HitachiController", "storage.HitachiDisk", "storage.NetAppBaseDisk", "storage.NetAppCluster", "storage.NetAppNode", "storage.PhysicalDisk", "storage.PhysicalDiskExtension", "storage.PureArray", "storage.PureController", "storage.PureDisk", "storage.SasExpander", "storage.VirtualDrive", "storage.VirtualDriveContainer"])
    ...
    def hash
      [class_id, object_type, model, presence, revision, serial, vendor, previous_fru].hash
    end
    ...
    def build_from_hash(attributes)
      ...
      EquipmentBaseAllOf.openapi_types.each_pair do |key, type|
        if attributes[EquipmentBaseAllOf.attribute_map[key]].nil? && EquipmentBaseAllOf.openapi_nullable.include?(key)
          self.send("#{key}=", nil)
        elsif type =~ /\AArray<(.*)>/i
          # check to ensure the input is an array given that the attribute
          # is documented as an array but the input is not
          if attributes[EquipmentBaseAllOf.attribute_map[key]].is_a?(Array)
            self.send("#{key}=", attributes[EquipmentBaseAllOf.attribute_map[key]].map { |v| _deserialize($1, v) })
          end
        elsif !attributes[EquipmentBaseAllOf.attribute_map[key]].nil?
          self.send("#{key}=", _deserialize(type, attributes[EquipmentBaseAllOf.attribute_map[key]]))
        end
      end
    ...
    def to_hash
      hash = {}
      EquipmentBaseAllOf.attribute_map.each_pair do |attr, param|
        value = self.send(attr)
        if value.nil?
          is_nullable = EquipmentBaseAllOf.openapi_nullable.include?(attr)
