...
module IntersightClient
  # A relationship to the 'hyperflex.HxapHostInterface' resource, or the expanded 'hyperflex.HxapHostInterface' resource, or the 'null' value.
  module HyperflexHxapHostInterfaceRelationship
    class << self
