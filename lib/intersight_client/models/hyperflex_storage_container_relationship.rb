...
module IntersightClient
  # A relationship to the 'hyperflex.StorageContainer' resource, or the expanded 'hyperflex.StorageContainer' resource, or the 'null' value.
  module HyperflexStorageContainerRelationship
    class << self
