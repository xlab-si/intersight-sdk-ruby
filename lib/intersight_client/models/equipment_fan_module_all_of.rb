...
module IntersightClient
  ...
  class EquipmentFanModuleAllOf
    ...
    attr_accessor :equipment_expander_module

    attr_accessor :equipment_io_card
    ...
    def self.attribute_map
      {
        ...
        :'equipment_expander_module' => :'EquipmentExpanderModule',
        :'equipment_io_card' => :'EquipmentIoCard',
    ...
    def self.openapi_types
      {
        ...
        :'equipment_expander_module' => :'EquipmentExpanderModuleRelationship',
        :'equipment_io_card' => :'EquipmentIoCardRelationship',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IntersightClient::EquipmentFanModuleAllOf` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IntersightClient::EquipmentFanModuleAllOf`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'class_id')
        ...
        self.class_id = 'equipment.FanModule'
      end

      if attributes.key?(:'object_type')
        self.object_type = attributes[:'object_type']
      else
        self.object_type = 'equipment.FanModule'
      end
      ...
      if attributes.key?(:'equipment_expander_module')
        self.equipment_expander_module = attributes[:'equipment_expander_module']
      end

      if attributes.key?(:'equipment_io_card')
        self.equipment_io_card = attributes[:'equipment_io_card']
      end
      ...
      if attributes.key?(:'fans')
        if (value = attributes[:'fans']).is_a?(Array)
          self.fans = value
        end
      end
    ...
    def valid?
      ...
      class_id_validator = EnumAttributeValidator.new('String', ["equipment.FanModule"])
      return false unless class_id_validator.valid?(@class_id)
      return false if @object_type.nil?
      object_type_validator = EnumAttributeValidator.new('String', ["equipment.FanModule"])
    ...
    def class_id=(class_id)
      validator = EnumAttributeValidator.new('String', ["equipment.FanModule"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          equipment_expander_module == o.equipment_expander_module &&
          equipment_io_card == o.equipment_io_card &&
    ...
    def hash
      [class_id, object_type, description, module_id, oper_reason, oper_state, part_number, pid, sku, tray_id, vid, compute_rack_unit, equipment_chassis, equipment_expander_module, equipment_io_card, equipment_rack_enclosure, fans, inventory_device_info, network_element, registered_device].hash
    end
    ...
    def build_from_hash(attributes)
      ...
      EquipmentFanModuleAllOf.openapi_types.each_pair do |key, type|
        if attributes[EquipmentFanModuleAllOf.attribute_map[key]].nil? && EquipmentFanModuleAllOf.openapi_nullable.include?(key)
          self.send("#{key}=", nil)
        elsif type =~ /\AArray<(.*)>/i
          # check to ensure the input is an array given that the attribute
          # is documented as an array but the input is not
          if attributes[EquipmentFanModuleAllOf.attribute_map[key]].is_a?(Array)
            self.send("#{key}=", attributes[EquipmentFanModuleAllOf.attribute_map[key]].map { |v| _deserialize($1, v) })
          end
        elsif !attributes[EquipmentFanModuleAllOf.attribute_map[key]].nil?
          self.send("#{key}=", _deserialize(type, attributes[EquipmentFanModuleAllOf.attribute_map[key]]))
        end
      end
    ...
    def to_hash
      hash = {}
      EquipmentFanModuleAllOf.attribute_map.each_pair do |attr, param|
        value = self.send(attr)
        if value.nil?
          is_nullable = EquipmentFanModuleAllOf.openapi_nullable.include?(attr)
