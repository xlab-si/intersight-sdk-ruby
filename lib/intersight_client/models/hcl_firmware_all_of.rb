...
module IntersightClient
  ...
  class HclFirmwareAllOf
    ...
    attr_accessor :latest_driver

    # True if the firmware is latest recommended firmware.
    attr_accessor :latest_firmware
    ...
    def self.openapi_types
      {
        ...
        :'id' => :'String',
        :'latest_driver' => :'Boolean',
        :'latest_firmware' => :'Boolean'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IntersightClient::HclFirmwareAllOf` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IntersightClient::HclFirmwareAllOf`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'class_id')
        ...
        self.class_id = 'hcl.Firmware'
      end

      if attributes.key?(:'object_type')
        self.object_type = attributes[:'object_type']
      else
        self.object_type = 'hcl.Firmware'
      end
      ...
      if attributes.key?(:'driver_version')
        self.driver_version = attributes[:'driver_version']
      end
      ...
      if attributes.key?(:'latest_driver')
        self.latest_driver = attributes[:'latest_driver']
      end

      if attributes.key?(:'latest_firmware')
        self.latest_firmware = attributes[:'latest_firmware']
      end
    end
    ...
    def valid?
      ...
      class_id_validator = EnumAttributeValidator.new('String', ["hcl.Firmware"])
      return false unless class_id_validator.valid?(@class_id)
      return false if @object_type.nil?
      object_type_validator = EnumAttributeValidator.new('String', ["hcl.Firmware"])
    ...
    def class_id=(class_id)
      validator = EnumAttributeValidator.new('String', ["hcl.Firmware"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          id == o.id &&
          latest_driver == o.latest_driver &&
          latest_firmware == o.latest_firmware
    end
    ...
    def hash
      [class_id, object_type, driver_name, driver_version, error_code, firmware_version, id, latest_driver, latest_firmware].hash
    end
    ...
    def build_from_hash(attributes)
      ...
      HclFirmwareAllOf.openapi_types.each_pair do |key, type|
        if attributes[HclFirmwareAllOf.attribute_map[key]].nil? && HclFirmwareAllOf.openapi_nullable.include?(key)
          self.send("#{key}=", nil)
        elsif type =~ /\AArray<(.*)>/i
          # check to ensure the input is an array given that the attribute
          # is documented as an array but the input is not
          if attributes[HclFirmwareAllOf.attribute_map[key]].is_a?(Array)
            self.send("#{key}=", attributes[HclFirmwareAllOf.attribute_map[key]].map { |v| _deserialize($1, v) })
          end
        elsif !attributes[HclFirmwareAllOf.attribute_map[key]].nil?
          self.send("#{key}=", _deserialize(type, attributes[HclFirmwareAllOf.attribute_map[key]]))
        end
      end
    ...
    def to_hash
      hash = {}
      HclFirmwareAllOf.attribute_map.each_pair do |attr, param|
        value = self.send(attr)
        if value.nil?
          is_nullable = HclFirmwareAllOf.openapi_nullable.include?(attr)
