...
module IntersightClient
  ...
  class MemoryArrayAllOf
    ...
    attr_accessor :persistent_memory_units
    ...
    def self.openapi_types
      {
        ...
        :'persistent_memory_units' => :'Array<MemoryPersistentMemoryUnitRelationship>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IntersightClient::MemoryArrayAllOf` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IntersightClient::MemoryArrayAllOf`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'cpu_id')
        self.cpu_id = attributes[:'cpu_id']
      end

      if attributes.key?(:'current_capacity')
      ...
      if attributes.key?(:'max_capacity')
      ...
      if attributes.key?(:'persistent_memory_units')
        if (value = attributes[:'persistent_memory_units']).is_a?(Array)
          self.persistent_memory_units = value
        end
      end
    ...
    def valid?
      ...
      class_id_validator = EnumAttributeValidator.new('String', ["memory.Array"])
      return false unless class_id_validator.valid?(@class_id)
      return false if @object_type.nil?
      object_type_validator = EnumAttributeValidator.new('String', ["memory.Array"])
    ...
    def class_id=(class_id)
      validator = EnumAttributeValidator.new('String', ["memory.Array"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          error_correction == o.error_correction &&
          ...
          persistent_memory_units == o.persistent_memory_units &&
    ...
    def hash
      [class_id, object_type, array_id, cpu_id, current_capacity, error_correction, max_capacity, max_devices, oper_power_state, compute_blade, compute_board, compute_rack_unit, inventory_device_info, persistent_memory_units, registered_device, units].hash
    end
    ...
    def build_from_hash(attributes)
      ...
      MemoryArrayAllOf.openapi_types.each_pair do |key, type|
        if attributes[MemoryArrayAllOf.attribute_map[key]].nil? && MemoryArrayAllOf.openapi_nullable.include?(key)
          self.send("#{key}=", nil)
        elsif type =~ /\AArray<(.*)>/i
          # check to ensure the input is an array given that the attribute
          # is documented as an array but the input is not
          if attributes[MemoryArrayAllOf.attribute_map[key]].is_a?(Array)
            self.send("#{key}=", attributes[MemoryArrayAllOf.attribute_map[key]].map { |v| _deserialize($1, v) })
          end
        elsif !attributes[MemoryArrayAllOf.attribute_map[key]].nil?
          self.send("#{key}=", _deserialize(type, attributes[MemoryArrayAllOf.attribute_map[key]]))
        end
      end
    ...
    def to_hash
      hash = {}
      MemoryArrayAllOf.attribute_map.each_pair do |attr, param|
        value = self.send(attr)
        if value.nil?
          is_nullable = MemoryArrayAllOf.openapi_nullable.include?(attr)
