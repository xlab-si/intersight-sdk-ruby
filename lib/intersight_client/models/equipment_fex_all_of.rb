  ...
  class EquipmentFexAllOf
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IntersightClient::EquipmentFexAllOf` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IntersightClient::EquipmentFexAllOf`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'class_id')
        ...
        self.class_id = 'equipment.Fex'
      end

      if attributes.key?(:'object_type')
        self.object_type = attributes[:'object_type']
      else
        self.object_type = 'equipment.Fex'
      end
      ...
      if attributes.key?(:'discovery_state')
        self.discovery_state = attributes[:'discovery_state']
      end
    ...
    def valid?
      ...
      class_id_validator = EnumAttributeValidator.new('String', ["equipment.Fex"])
      return false unless class_id_validator.valid?(@class_id)
      return false if @object_type.nil?
      object_type_validator = EnumAttributeValidator.new('String', ["equipment.Fex"])
    ...
    def class_id=(class_id)
      validator = EnumAttributeValidator.new('String', ["equipment.Fex"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          discovery_state == o.discovery_state &&
          fans == o.fans &&
    ...
    def hash
      [class_id, object_type, connection_path, discovery_state, fans, inventory_device_info, ioms, locator_led, network_element, psus, registered_device].hash
    end
    ...
    def build_from_hash(attributes)
      ...
      EquipmentFexAllOf.openapi_types.each_pair do |key, type|
        if attributes[EquipmentFexAllOf.attribute_map[key]].nil? && EquipmentFexAllOf.openapi_nullable.include?(key)
          self.send("#{key}=", nil)
        elsif type =~ /\AArray<(.*)>/i
          # check to ensure the input is an array given that the attribute
          # is documented as an array but the input is not
          if attributes[EquipmentFexAllOf.attribute_map[key]].is_a?(Array)
            self.send("#{key}=", attributes[EquipmentFexAllOf.attribute_map[key]].map { |v| _deserialize($1, v) })
          end
        elsif !attributes[EquipmentFexAllOf.attribute_map[key]].nil?
          self.send("#{key}=", _deserialize(type, attributes[EquipmentFexAllOf.attribute_map[key]]))
        end
      end
    ...
    def to_hash
      hash = {}
      EquipmentFexAllOf.attribute_map.each_pair do |attr, param|
        value = self.send(attr)
        if value.nil?
          is_nullable = EquipmentFexAllOf.openapi_nullable.include?(attr)
