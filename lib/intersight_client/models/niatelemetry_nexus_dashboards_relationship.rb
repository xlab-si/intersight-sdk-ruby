...
module IntersightClient
  # A relationship to the 'niatelemetry.NexusDashboards' resource, or the expanded 'niatelemetry.NexusDashboards' resource, or the 'null' value.
  module NiatelemetryNexusDashboardsRelationship
    class << self
