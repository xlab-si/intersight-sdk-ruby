...
module IntersightClient
  ...
  class ApplianceNodeStatusAllOf
    ...
    attr_accessor :file_system_statuses
    ...
    def self.attribute_map
      {
        ...
        :'file_system_statuses' => :'FileSystemStatuses',
        :'node_info' => :'NodeInfo',
    ...
    def self.openapi_types
      {
        ...
        :'file_system_statuses' => :'Array<ApplianceFileSystemStatusRelationship>',
        :'node_info' => :'ApplianceNodeInfoRelationship',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IntersightClient::ApplianceNodeStatusAllOf` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IntersightClient::ApplianceNodeStatusAllOf`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'class_id')
        ...
        self.class_id = 'appliance.NodeStatus'
      end

      if attributes.key?(:'object_type')
        self.object_type = attributes[:'object_type']
      else
        self.object_type = 'appliance.NodeStatus'
      end
      ...
      if attributes.key?(:'file_system_statuses')
        if (value = attributes[:'file_system_statuses']).is_a?(Array)
          self.file_system_statuses = value
        end
      end
    ...
    def valid?
      ...
      class_id_validator = EnumAttributeValidator.new('String', ["appliance.NodeStatus"])
      return false unless class_id_validator.valid?(@class_id)
      return false if @object_type.nil?
      object_type_validator = EnumAttributeValidator.new('String', ["appliance.NodeStatus"])
      return false unless object_type_validator.valid?(@object_type)
      node_state_validator = EnumAttributeValidator.new('String', ["Down", "Preparing", "Ready"])
      return false unless node_state_validator.valid?(@node_state)
    ...
    def class_id=(class_id)
      validator = EnumAttributeValidator.new('String', ["appliance.NodeStatus"])
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] node_state Object to be assigned
    def node_state=(node_state)
      validator = EnumAttributeValidator.new('String', ["Down", "Preparing", "Ready"])
      unless validator.valid?(node_state)
        fail ArgumentError, "invalid value for \"node_state\", must be one of #{validator.allowable_values}."
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          file_system_statuses == o.file_system_statuses &&
    ...
    def hash
      [class_id, object_type, cpu_usage, mem_usage, node_id, node_state, operational_status, status_checks, file_system_statuses, node_info, system_status].hash
    end
    ...
    def build_from_hash(attributes)
      ...
      ApplianceNodeStatusAllOf.openapi_types.each_pair do |key, type|
        if attributes[ApplianceNodeStatusAllOf.attribute_map[key]].nil? && ApplianceNodeStatusAllOf.openapi_nullable.include?(key)
          self.send("#{key}=", nil)
        elsif type =~ /\AArray<(.*)>/i
          # check to ensure the input is an array given that the attribute
          # is documented as an array but the input is not
          if attributes[ApplianceNodeStatusAllOf.attribute_map[key]].is_a?(Array)
            self.send("#{key}=", attributes[ApplianceNodeStatusAllOf.attribute_map[key]].map { |v| _deserialize($1, v) })
          end
        elsif !attributes[ApplianceNodeStatusAllOf.attribute_map[key]].nil?
          self.send("#{key}=", _deserialize(type, attributes[ApplianceNodeStatusAllOf.attribute_map[key]]))
        end
      end
    ...
    def to_hash
      hash = {}
      ApplianceNodeStatusAllOf.attribute_map.each_pair do |attr, param|
        value = self.send(attr)
        if value.nil?
          is_nullable = ApplianceNodeStatusAllOf.openapi_nullable.include?(attr)
