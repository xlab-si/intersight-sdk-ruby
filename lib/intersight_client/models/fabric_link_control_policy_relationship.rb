...
module IntersightClient
  # A relationship to the 'fabric.LinkControlPolicy' resource, or the expanded 'fabric.LinkControlPolicy' resource, or the 'null' value.
  module FabricLinkControlPolicyRelationship
    class << self
