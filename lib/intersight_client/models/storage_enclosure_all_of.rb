...
module IntersightClient
  ...
  class StorageEnclosureAllOf
    ...
    attr_accessor :enclosure_disk_slots

    # An array of relationships to storageEnclosureDisk resources.
    attr_accessor :enclosure_disks
    ...
    def self.openapi_types
      {
        ...
        :'enclosure_disk_slots' => :'Array<StorageEnclosureDiskSlotEpRelationship>',
        :'enclosure_disks' => :'Array<StorageEnclosureDiskRelationship>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `IntersightClient::StorageEnclosureAllOf` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `IntersightClient::StorageEnclosureAllOf`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'class_id')
        ...
        self.class_id = 'storage.Enclosure'
      end

      if attributes.key?(:'object_type')
        self.object_type = attributes[:'object_type']
      else
        self.object_type = 'storage.Enclosure'
      end
      ...
      if attributes.key?(:'enclosure_id')
        self.enclosure_id = attributes[:'enclosure_id']
      end

      if attributes.key?(:'num_slots')
        self.num_slots = attributes[:'num_slots']
      end
      ...
      if attributes.key?(:'enclosure_disk_slots')
        if (value = attributes[:'enclosure_disk_slots']).is_a?(Array)
          self.enclosure_disk_slots = value
        end
      end

      if attributes.key?(:'enclosure_disks')
        if (value = attributes[:'enclosure_disks']).is_a?(Array)
          self.enclosure_disks = value
        end
      end
    ...
    def valid?
      ...
      class_id_validator = EnumAttributeValidator.new('String', ["storage.Enclosure"])
      return false unless class_id_validator.valid?(@class_id)
      return false if @object_type.nil?
      object_type_validator = EnumAttributeValidator.new('String', ["storage.Enclosure"])
    ...
    def class_id=(class_id)
      validator = EnumAttributeValidator.new('String', ["storage.Enclosure"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          enclosure_id == o.enclosure_id &&
          num_slots == o.num_slots &&
          server_id == o.server_id &&
          type == o.type &&
          compute_blade == o.compute_blade &&
          compute_rack_unit == o.compute_rack_unit &&
          enclosure_disk_slots == o.enclosure_disk_slots &&
          enclosure_disks == o.enclosure_disks &&
    ...
    def hash
      [class_id, object_type, chassis_id, description, enclosure_id, num_slots, server_id, type, compute_blade, compute_rack_unit, enclosure_disk_slots, enclosure_disks, equipment_chassis, inventory_device_info, physical_disks, registered_device].hash
    end
    ...
    def build_from_hash(attributes)
      ...
      StorageEnclosureAllOf.openapi_types.each_pair do |key, type|
        if attributes[StorageEnclosureAllOf.attribute_map[key]].nil? && StorageEnclosureAllOf.openapi_nullable.include?(key)
          self.send("#{key}=", nil)
        elsif type =~ /\AArray<(.*)>/i
          # check to ensure the input is an array given that the attribute
          # is documented as an array but the input is not
          if attributes[StorageEnclosureAllOf.attribute_map[key]].is_a?(Array)
            self.send("#{key}=", attributes[StorageEnclosureAllOf.attribute_map[key]].map { |v| _deserialize($1, v) })
          end
        elsif !attributes[StorageEnclosureAllOf.attribute_map[key]].nil?
          self.send("#{key}=", _deserialize(type, attributes[StorageEnclosureAllOf.attribute_map[key]]))
        end
      end
    ...
    def to_hash
      hash = {}
      StorageEnclosureAllOf.attribute_map.each_pair do |attr, param|
        value = self.send(attr)
        if value.nil?
          is_nullable = StorageEnclosureAllOf.openapi_nullable.include?(attr)
