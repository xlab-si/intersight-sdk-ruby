...
module IntersightClient
  class ResourcepoolApi
    ...
    # @param resourcepool_pool [ResourcepoolPool] The &#39;resourcepool.Pool&#39; resource to create.
    ...
    def create_resourcepool_pool(resourcepool_pool, opts = {})
      data, _status_code, _headers = create_resourcepool_pool_with_http_info(resourcepool_pool, opts)
      data
    end
    ...
    # @option opts [String] :if_match For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request.
    # @option opts [String] :if_none_match For methods that apply server-side changes, If-None-Match used with the * value can be used to create a resource not known to exist, guaranteeing that another resource creation didn&#39;t happen before, losing the data of the previous put. The request will be processed only if the eventually existing resource&#39;s ETag doesn&#39;t match any of the values listed. Otherwise, the status code 412 (Precondition Failed) is used. The asterisk is a special value representing any resource. It is only useful when creating a resource, usually with PUT, to check if another resource with the identity has already been created before. The comparison with the stored ETag uses the weak comparison algorithm, meaning two resources are considered identical if the content is equivalent - they don&#39;t have to be identical byte for byte.
    # @return [Array<(ResourcepoolPool, Integer, Hash)>] ResourcepoolPool data, response status code and response headers
    def create_resourcepool_pool_with_http_info(resourcepool_pool, opts = {})
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def delete_resourcepool_lease(moid, opts = {})
      delete_resourcepool_lease_with_http_info(moid, opts)
      nil
    end
    ...
    def delete_resourcepool_lease_with_http_info(moid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ResourcepoolApi.delete_resourcepool_lease ...'
      end
      # verify the required parameter 'moid' is set
      if @api_client.config.client_side_validation && moid.nil?
        fail ArgumentError, "Missing the required parameter 'moid' when calling ResourcepoolApi.delete_resourcepool_lease"
      end
      # resource path
      local_var_path = '/api/v1/resourcepool/Leases/{Moid}'.sub('{' + 'Moid' + '}', CGI.escape(moid.to_s))
      ...
      new_options = opts.merge(
        :operation => :"ResourcepoolApi.delete_resourcepool_lease",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ResourcepoolApi#delete_resourcepool_lease\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def delete_resourcepool_pool(moid, opts = {})
      delete_resourcepool_pool_with_http_info(moid, opts)
      nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def delete_resourcepool_pool_with_http_info(moid, opts = {})
      if @api_client.config.debugging
    ...
    def get_resourcepool_lease_by_moid(moid, opts = {})
      data, _status_code, _headers = get_resourcepool_lease_by_moid_with_http_info(moid, opts)
      data
    end
    ...
    # @param moid [String] The unique Moid identifier of a resource instance.
    # @param [Hash] opts the optional parameters
    # @return [Array<(ResourcepoolLease, Integer, Hash)>] ResourcepoolLease data, response status code and response headers
    def get_resourcepool_lease_by_moid_with_http_info(moid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ResourcepoolApi.get_resourcepool_lease_by_moid ...'
      end
      # verify the required parameter 'moid' is set
      if @api_client.config.client_side_validation && moid.nil?
        fail ArgumentError, "Missing the required parameter 'moid' when calling ResourcepoolApi.get_resourcepool_lease_by_moid"
      end
      # resource path
      local_var_path = '/api/v1/resourcepool/Leases/{Moid}'.sub('{' + 'Moid' + '}', CGI.escape(moid.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'ResourcepoolLease'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['cookieAuth', 'http_signature', 'oAuth2', 'oAuth2']

      new_options = opts.merge(
        :operation => :"ResourcepoolApi.get_resourcepool_lease_by_moid",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ResourcepoolApi#get_resourcepool_lease_by_moid\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_resourcepool_lease_list(opts = {})
      data, _status_code, _headers = get_resourcepool_lease_list_with_http_info(opts)
      data
    end
    ...
    # @option opts [String] :at Similar to \&quot;$filter\&quot;, but \&quot;at\&quot; is specifically used to filter versioning information properties for resources to return. A URI with an \&quot;at\&quot; Query Option identifies a subset of the Entries from the Collection of Entries identified by the Resource Path section of the URI. The subset is determined by selecting only the Entries that satisfy the predicate expression specified by the query option. The expression language that is used in at operators supports references to properties and literals. The literal values can be strings enclosed in single quotes, numbers and boolean values (true or false) or any of the additional literal representations shown in the Abstract Type System section.
    # @option opts [String] :tags The &#39;tags&#39; parameter is used to request a summary of the Tag utilization for this resource. When the &#39;tags&#39; parameter is specified, the response provides a list of tag keys, the number of times the key has been used across all documents, and the tag values that have been assigned to the tag key.
    # @return [Array<(ResourcepoolLeaseResponse, Integer, Hash)>] ResourcepoolLeaseResponse data, response status code and response headers
    def get_resourcepool_lease_list_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ResourcepoolApi.get_resourcepool_lease_list ...'
      end
      ...
      # resource path
      local_var_path = '/api/v1/resourcepool/Leases'
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'ResourcepoolLeaseResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['cookieAuth', 'http_signature', 'oAuth2', 'oAuth2']

      new_options = opts.merge(
        :operation => :"ResourcepoolApi.get_resourcepool_lease_list",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ResourcepoolApi#get_resourcepool_lease_list\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_resourcepool_lease_resource_by_moid(moid, opts = {})
      data, _status_code, _headers = get_resourcepool_lease_resource_by_moid_with_http_info(moid, opts)
      data
    end
    ...
    # @param moid [String] The unique Moid identifier of a resource instance.
    # @param [Hash] opts the optional parameters
    # @return [Array<(ResourcepoolLeaseResource, Integer, Hash)>] ResourcepoolLeaseResource data, response status code and response headers
    def get_resourcepool_lease_resource_by_moid_with_http_info(moid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ResourcepoolApi.get_resourcepool_lease_resource_by_moid ...'
      end
      # verify the required parameter 'moid' is set
      if @api_client.config.client_side_validation && moid.nil?
        fail ArgumentError, "Missing the required parameter 'moid' when calling ResourcepoolApi.get_resourcepool_lease_resource_by_moid"
      end
      # resource path
      local_var_path = '/api/v1/resourcepool/LeaseResources/{Moid}'.sub('{' + 'Moid' + '}', CGI.escape(moid.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'ResourcepoolLeaseResource'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['cookieAuth', 'http_signature', 'oAuth2', 'oAuth2']

      new_options = opts.merge(
        :operation => :"ResourcepoolApi.get_resourcepool_lease_resource_by_moid",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ResourcepoolApi#get_resourcepool_lease_resource_by_moid\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_resourcepool_lease_resource_list(opts = {})
      data, _status_code, _headers = get_resourcepool_lease_resource_list_with_http_info(opts)
      data
    end
    ...
    # @option opts [String] :at Similar to \&quot;$filter\&quot;, but \&quot;at\&quot; is specifically used to filter versioning information properties for resources to return. A URI with an \&quot;at\&quot; Query Option identifies a subset of the Entries from the Collection of Entries identified by the Resource Path section of the URI. The subset is determined by selecting only the Entries that satisfy the predicate expression specified by the query option. The expression language that is used in at operators supports references to properties and literals. The literal values can be strings enclosed in single quotes, numbers and boolean values (true or false) or any of the additional literal representations shown in the Abstract Type System section.
    # @option opts [String] :tags The &#39;tags&#39; parameter is used to request a summary of the Tag utilization for this resource. When the &#39;tags&#39; parameter is specified, the response provides a list of tag keys, the number of times the key has been used across all documents, and the tag values that have been assigned to the tag key.
    # @return [Array<(ResourcepoolLeaseResourceResponse, Integer, Hash)>] ResourcepoolLeaseResourceResponse data, response status code and response headers
    def get_resourcepool_lease_resource_list_with_http_info(opts = {})
      if @api_client.config.debugging
    ...
    # @param [Hash] opts the optional parameters
    # @return [ResourcepoolPool]
    def get_resourcepool_pool_by_moid(moid, opts = {})
      data, _status_code, _headers = get_resourcepool_pool_by_moid_with_http_info(moid, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(ResourcepoolPool, Integer, Hash)>] ResourcepoolPool data, response status code and response headers
    def get_resourcepool_pool_by_moid_with_http_info(moid, opts = {})
      if @api_client.config.debugging
    ...
    def get_resourcepool_pool_list(opts = {})
      data, _status_code, _headers = get_resourcepool_pool_list_with_http_info(opts)
      data
    end
    ...
    # @option opts [String] :at Similar to \&quot;$filter\&quot;, but \&quot;at\&quot; is specifically used to filter versioning information properties for resources to return. A URI with an \&quot;at\&quot; Query Option identifies a subset of the Entries from the Collection of Entries identified by the Resource Path section of the URI. The subset is determined by selecting only the Entries that satisfy the predicate expression specified by the query option. The expression language that is used in at operators supports references to properties and literals. The literal values can be strings enclosed in single quotes, numbers and boolean values (true or false) or any of the additional literal representations shown in the Abstract Type System section.
    # @option opts [String] :tags The &#39;tags&#39; parameter is used to request a summary of the Tag utilization for this resource. When the &#39;tags&#39; parameter is specified, the response provides a list of tag keys, the number of times the key has been used across all documents, and the tag values that have been assigned to the tag key.
    # @return [Array<(ResourcepoolPoolResponse, Integer, Hash)>] ResourcepoolPoolResponse data, response status code and response headers
    def get_resourcepool_pool_list_with_http_info(opts = {})
      if @api_client.config.debugging
    ...
    def get_resourcepool_pool_member_by_moid(moid, opts = {})
      data, _status_code, _headers = get_resourcepool_pool_member_by_moid_with_http_info(moid, opts)
      data
    end
    ...
    # @param moid [String] The unique Moid identifier of a resource instance.
    # @param [Hash] opts the optional parameters
    # @return [Array<(ResourcepoolPoolMember, Integer, Hash)>] ResourcepoolPoolMember data, response status code and response headers
    def get_resourcepool_pool_member_by_moid_with_http_info(moid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ResourcepoolApi.get_resourcepool_pool_member_by_moid ...'
      end
      # verify the required parameter 'moid' is set
      if @api_client.config.client_side_validation && moid.nil?
        fail ArgumentError, "Missing the required parameter 'moid' when calling ResourcepoolApi.get_resourcepool_pool_member_by_moid"
      end
      # resource path
      local_var_path = '/api/v1/resourcepool/PoolMembers/{Moid}'.sub('{' + 'Moid' + '}', CGI.escape(moid.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'ResourcepoolPoolMember'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['cookieAuth', 'http_signature', 'oAuth2', 'oAuth2']

      new_options = opts.merge(
        :operation => :"ResourcepoolApi.get_resourcepool_pool_member_by_moid",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ResourcepoolApi#get_resourcepool_pool_member_by_moid\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_resourcepool_pool_member_list(opts = {})
      data, _status_code, _headers = get_resourcepool_pool_member_list_with_http_info(opts)
      data
    end
    ...
    # @option opts [String] :at Similar to \&quot;$filter\&quot;, but \&quot;at\&quot; is specifically used to filter versioning information properties for resources to return. A URI with an \&quot;at\&quot; Query Option identifies a subset of the Entries from the Collection of Entries identified by the Resource Path section of the URI. The subset is determined by selecting only the Entries that satisfy the predicate expression specified by the query option. The expression language that is used in at operators supports references to properties and literals. The literal values can be strings enclosed in single quotes, numbers and boolean values (true or false) or any of the additional literal representations shown in the Abstract Type System section.
    # @option opts [String] :tags The &#39;tags&#39; parameter is used to request a summary of the Tag utilization for this resource. When the &#39;tags&#39; parameter is specified, the response provides a list of tag keys, the number of times the key has been used across all documents, and the tag values that have been assigned to the tag key.
    # @return [Array<(ResourcepoolPoolMemberResponse, Integer, Hash)>] ResourcepoolPoolMemberResponse data, response status code and response headers
    def get_resourcepool_pool_member_list_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ResourcepoolApi.get_resourcepool_pool_member_list ...'
      end
      allowable_values = ["allpages", "none"]
      if @api_client.config.client_side_validation && opts[:'inlinecount'] && !allowable_values.include?(opts[:'inlinecount'])
        fail ArgumentError, "invalid value for \"inlinecount\", must be one of #{allowable_values}"
      ...
      # resource path
      local_var_path = '/api/v1/resourcepool/PoolMembers'
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'ResourcepoolPoolMemberResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['cookieAuth', 'http_signature', 'oAuth2', 'oAuth2']

      new_options = opts.merge(
        :operation => :"ResourcepoolApi.get_resourcepool_pool_member_list",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ResourcepoolApi#get_resourcepool_pool_member_list\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_resourcepool_universe_by_moid(moid, opts = {})
    ...
    # @param moid [String] The unique Moid identifier of a resource instance.
    # @param [Hash] opts the optional parameters
    # @return [Array<(ResourcepoolUniverse, Integer, Hash)>] ResourcepoolUniverse data, response status code and response headers
    def get_resourcepool_universe_by_moid_with_http_info(moid, opts = {})
      if @api_client.config.debugging
    ...
    def get_resourcepool_universe_list(opts = {})
    ...
    # @option opts [String] :at Similar to \&quot;$filter\&quot;, but \&quot;at\&quot; is specifically used to filter versioning information properties for resources to return. A URI with an \&quot;at\&quot; Query Option identifies a subset of the Entries from the Collection of Entries identified by the Resource Path section of the URI. The subset is determined by selecting only the Entries that satisfy the predicate expression specified by the query option. The expression language that is used in at operators supports references to properties and literals. The literal values can be strings enclosed in single quotes, numbers and boolean values (true or false) or any of the additional literal representations shown in the Abstract Type System section.
    # @option opts [String] :tags The &#39;tags&#39; parameter is used to request a summary of the Tag utilization for this resource. When the &#39;tags&#39; parameter is specified, the response provides a list of tag keys, the number of times the key has been used across all documents, and the tag values that have been assigned to the tag key.
    # @return [Array<(ResourcepoolUniverseResponse, Integer, Hash)>] ResourcepoolUniverseResponse data, response status code and response headers
    def get_resourcepool_universe_list_with_http_info(opts = {})
      if @api_client.config.debugging
    ...
    # @param moid [String] The unique Moid identifier of a resource instance.
    # @param resourcepool_pool [ResourcepoolPool] The &#39;resourcepool.Pool&#39; resource to update.
    # @param [Hash] opts the optional parameters
    # @option opts [String] :if_match For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request.
    # @return [ResourcepoolPool]
    def patch_resourcepool_pool(moid, resourcepool_pool, opts = {})
      data, _status_code, _headers = patch_resourcepool_pool_with_http_info(moid, resourcepool_pool, opts)
      data
    end
    ...
    # @option opts [String] :if_match For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request.
    # @return [Array<(ResourcepoolPool, Integer, Hash)>] ResourcepoolPool data, response status code and response headers
    def patch_resourcepool_pool_with_http_info(moid, resourcepool_pool, opts = {})
      if @api_client.config.debugging
    ...
    # @option opts [String] :if_match For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request.
    # @return [ResourcepoolPool]
    def update_resourcepool_pool(moid, resourcepool_pool, opts = {})
      data, _status_code, _headers = update_resourcepool_pool_with_http_info(moid, resourcepool_pool, opts)
      data
    end
    ...
    # @option opts [String] :if_match For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request.
    # @return [Array<(ResourcepoolPool, Integer, Hash)>] ResourcepoolPool data, response status code and response headers
    def update_resourcepool_pool_with_http_info(moid, resourcepool_pool, opts = {})
      if @api_client.config.debugging
