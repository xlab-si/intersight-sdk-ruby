...
module IntersightClient
  class MetaApi
    ...
    # @return [nil]
    def delete_meta_definition(moid, opts = {})
      delete_meta_definition_with_http_info(moid, opts)
      nil
    end
    ...
    def delete_meta_definition_with_http_info(moid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: MetaApi.delete_meta_definition ...'
      end
      # verify the required parameter 'moid' is set
      if @api_client.config.client_side_validation && moid.nil?
        fail ArgumentError, "Missing the required parameter 'moid' when calling MetaApi.delete_meta_definition"
      end
      # resource path
      local_var_path = '/api/v1/meta/Definitions/{Moid}'.sub('{' + 'Moid' + '}', CGI.escape(moid.to_s))
      ...
      new_options = opts.merge(
        :operation => :"MetaApi.delete_meta_definition",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: MetaApi#delete_meta_definition\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def get_meta_definition_by_moid(moid, opts = {})
      data, _status_code, _headers = get_meta_definition_by_moid_with_http_info(moid, opts)
      data
    end
    ...
    # @param moid [String] The unique Moid identifier of a resource instance.
    # @param [Hash] opts the optional parameters
    # @return [Array<(MetaDefinition, Integer, Hash)>] MetaDefinition data, response status code and response headers
    def get_meta_definition_by_moid_with_http_info(moid, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: MetaApi.get_meta_definition_by_moid ...'
      end
      # verify the required parameter 'moid' is set
      if @api_client.config.client_side_validation && moid.nil?
        fail ArgumentError, "Missing the required parameter 'moid' when calling MetaApi.get_meta_definition_by_moid"
      end
      # resource path
      local_var_path = '/api/v1/meta/Definitions/{Moid}'.sub('{' + 'Moid' + '}', CGI.escape(moid.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'MetaDefinition'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['cookieAuth', 'http_signature', 'oAuth2', 'oAuth2']

      new_options = opts.merge(
        :operation => :"MetaApi.get_meta_definition_by_moid",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: MetaApi#get_meta_definition_by_moid\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_meta_definition_list(opts = {})
      data, _status_code, _headers = get_meta_definition_list_with_http_info(opts)
      data
    end
    ...
    # @option opts [String] :at Similar to \&quot;$filter\&quot;, but \&quot;at\&quot; is specifically used to filter versioning information properties for resources to return. A URI with an \&quot;at\&quot; Query Option identifies a subset of the Entries from the Collection of Entries identified by the Resource Path section of the URI. The subset is determined by selecting only the Entries that satisfy the predicate expression specified by the query option. The expression language that is used in at operators supports references to properties and literals. The literal values can be strings enclosed in single quotes, numbers and boolean values (true or false) or any of the additional literal representations shown in the Abstract Type System section.
    # @option opts [String] :tags The &#39;tags&#39; parameter is used to request a summary of the Tag utilization for this resource. When the &#39;tags&#39; parameter is specified, the response provides a list of tag keys, the number of times the key has been used across all documents, and the tag values that have been assigned to the tag key.
    # @return [Array<(MetaDefinitionResponse, Integer, Hash)>] MetaDefinitionResponse data, response status code and response headers
    def get_meta_definition_list_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: MetaApi.get_meta_definition_list ...'
      end
      ...
      # resource path
      local_var_path = '/api/v1/meta/Definitions'
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'MetaDefinitionResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['cookieAuth', 'http_signature', 'oAuth2', 'oAuth2']

      new_options = opts.merge(
        :operation => :"MetaApi.get_meta_definition_list",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: MetaApi#get_meta_definition_list\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
