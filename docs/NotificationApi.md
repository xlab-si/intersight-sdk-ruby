# IntersightClient::NotificationApi
...
begin
  # Read a 'notification.AccountSubscription' resource.
  result = api_instance.get_notification_account_subscription_list(opts)
  p result
rescue IntersightClient::ApiError => e
  puts "Error when calling NotificationApi->get_notification_account_subscription_list: #{e}"
end
```

#### Using the get_notification_account_subscription_list_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<NotificationAccountSubscriptionResponse>, Integer, Hash)> get_notification_account_subscription_list_with_http_info(opts)

```ruby
begin
  # Read a 'notification.AccountSubscription' resource.
  data, status_code, headers = api_instance.get_notification_account_subscription_list_with_http_info(opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <NotificationAccountSubscriptionResponse>
rescue IntersightClient::ApiError => e
  puts "Error when calling NotificationApi->get_notification_account_subscription_list_with_http_info: #{e}"
end
```
...
#### Using the update_notification_account_subscription_with_http_info variant
