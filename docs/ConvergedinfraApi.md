# IntersightClient::ConvergedinfraApi
...
| ---- | ---- | ----------- | ----- |
| **convergedinfra_health_check_definition** | [**ConvergedinfraHealthCheckDefinition**](ConvergedinfraHealthCheckDefinition.md) | The &#39;convergedinfra.HealthCheckDefinition&#39; resource to create. |  |
...
## delete_convergedinfra_health_check_definition

> delete_convergedinfra_health_check_definition(moid)
...
begin
  # Delete a 'convergedinfra.HealthCheckDefinition' resource.
  api_instance.delete_convergedinfra_health_check_definition(moid)
rescue IntersightClient::ApiError => e
  puts "Error when calling ConvergedinfraApi->delete_convergedinfra_health_check_definition: #{e}"
end
```

#### Using the delete_convergedinfra_health_check_definition_with_http_info variant
...
## get_convergedinfra_health_check_execution_by_moid

> <ConvergedinfraHealthCheckExecution> get_convergedinfra_health_check_execution_by_moid(moid)
...
begin
  # Read a 'convergedinfra.HealthCheckExecution' resource.
  result = api_instance.get_convergedinfra_health_check_execution_list(opts)
  p result
rescue IntersightClient::ApiError => e
  puts "Error when calling ConvergedinfraApi->get_convergedinfra_health_check_execution_list: #{e}"
end
```

#### Using the get_convergedinfra_health_check_execution_list_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<ConvergedinfraHealthCheckExecutionResponse>, Integer, Hash)> get_convergedinfra_health_check_execution_list_with_http_info(opts)

```ruby
begin
  # Read a 'convergedinfra.HealthCheckExecution' resource.
  data, status_code, headers = api_instance.get_convergedinfra_health_check_execution_list_with_http_info(opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <ConvergedinfraHealthCheckExecutionResponse>
rescue IntersightClient::ApiError => e
  puts "Error when calling ConvergedinfraApi->get_convergedinfra_health_check_execution_list_with_http_info: #{e}"
end
```
...
#### Using the get_convergedinfra_pod_by_moid_with_http_info variant
...
#### Using the get_convergedinfra_pod_list_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<ConvergedinfraPodResponse>, Integer, Hash)> get_convergedinfra_pod_list_with_http_info(opts)

```ruby
begin
  # Read a 'convergedinfra.Pod' resource.
  data, status_code, headers = api_instance.get_convergedinfra_pod_list_with_http_info(opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <ConvergedinfraPodResponse>
rescue IntersightClient::ApiError => e
  puts "Error when calling ConvergedinfraApi->get_convergedinfra_pod_list_with_http_info: #{e}"
end
```
...
#### Using the patch_convergedinfra_health_check_definition_with_http_info variant
