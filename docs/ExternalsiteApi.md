# IntersightClient::ExternalsiteApi
...
#### Using the get_externalsite_authorization_list_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<ExternalsiteAuthorizationResponse>, Integer, Hash)> get_externalsite_authorization_list_with_http_info(opts)

```ruby
begin
  # Read a 'externalsite.Authorization' resource.
  data, status_code, headers = api_instance.get_externalsite_authorization_list_with_http_info(opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <ExternalsiteAuthorizationResponse>
rescue IntersightClient::ApiError => e
  puts "Error when calling ExternalsiteApi->get_externalsite_authorization_list_with_http_info: #{e}"
end
```
...
#### Using the patch_externalsite_authorization_with_http_info variant
