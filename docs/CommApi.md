...
> <CommHttpProxyPolicyResponse> get_comm_http_proxy_policy_list(opts)
...
begin
  # Read a 'comm.HttpProxyPolicy' resource.
  result = api_instance.get_comm_http_proxy_policy_list(opts)
  p result
rescue IntersightClient::ApiError => e
  puts "Error when calling CommApi->get_comm_http_proxy_policy_list: #{e}"
end
```

#### Using the get_comm_http_proxy_policy_list_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<CommHttpProxyPolicyResponse>, Integer, Hash)> get_comm_http_proxy_policy_list_with_http_info(opts)

```ruby
begin
  # Read a 'comm.HttpProxyPolicy' resource.
  data, status_code, headers = api_instance.get_comm_http_proxy_policy_list_with_http_info(opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <CommHttpProxyPolicyResponse>
rescue IntersightClient::ApiError => e
  puts "Error when calling CommApi->get_comm_http_proxy_policy_list_with_http_info: #{e}"
end
```
...
> <CommHttpProxyPolicy> update_comm_http_proxy_policy(moid, comm_http_proxy_policy, opts)
