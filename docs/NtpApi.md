...
#### Using the get_ntp_policy_by_moid_with_http_info variant
...
#### Using the get_ntp_policy_list_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<NtpPolicyResponse>, Integer, Hash)> get_ntp_policy_list_with_http_info(opts)

```ruby
begin
  # Read a 'ntp.Policy' resource.
  data, status_code, headers = api_instance.get_ntp_policy_list_with_http_info(opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <NtpPolicyResponse>
rescue IntersightClient::ApiError => e
  puts "Error when calling NtpApi->get_ntp_policy_list_with_http_info: #{e}"
end
```
...
#### Using the patch_ntp_policy_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<NtpPolicy>, Integer, Hash)> patch_ntp_policy_with_http_info(moid, ntp_policy, opts)

```ruby
begin
  # Update a 'ntp.Policy' resource.
  data, status_code, headers = api_instance.patch_ntp_policy_with_http_info(moid, ntp_policy, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <NtpPolicy>
rescue IntersightClient::ApiError => e
  puts "Error when calling NtpApi->patch_ntp_policy_with_http_info: #{e}"
end
```
...
> <NtpPolicy> update_ntp_policy(moid, ntp_policy, opts)
