...
begin
  # Read a 'inventory.DeviceInfo' resource.
  result = api_instance.get_inventory_device_info_by_moid(moid)
  p result
rescue IntersightClient::ApiError => e
  puts "Error when calling InventoryApi->get_inventory_device_info_by_moid: #{e}"
end
```

#### Using the get_inventory_device_info_by_moid_with_http_info variant
...
#### Using the get_inventory_device_info_list_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<InventoryDeviceInfoResponse>, Integer, Hash)> get_inventory_device_info_list_with_http_info(opts)

```ruby
begin
  # Read a 'inventory.DeviceInfo' resource.
  data, status_code, headers = api_instance.get_inventory_device_info_list_with_http_info(opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <InventoryDeviceInfoResponse>
rescue IntersightClient::ApiError => e
  puts "Error when calling InventoryApi->get_inventory_device_info_list_with_http_info: #{e}"
end
```
...
> <InventoryGenericInventoryResponse> get_inventory_generic_inventory_list(opts)
...
#### Using the get_inventory_generic_inventory_list_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<InventoryGenericInventoryResponse>, Integer, Hash)> get_inventory_generic_inventory_list_with_http_info(opts)

```ruby
begin
  # Read a 'inventory.GenericInventory' resource.
  data, status_code, headers = api_instance.get_inventory_generic_inventory_list_with_http_info(opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <InventoryGenericInventoryResponse>
rescue IntersightClient::ApiError => e
  puts "Error when calling InventoryApi->get_inventory_generic_inventory_list_with_http_info: #{e}"
end
```
...
#### Using the patch_inventory_generic_inventory_with_http_info variant
