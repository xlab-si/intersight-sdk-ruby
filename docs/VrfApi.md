...
#### Using the get_vrf_vrf_by_moid_with_http_info variant
...
#### Using the get_vrf_vrf_list_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<VrfVrfResponse>, Integer, Hash)> get_vrf_vrf_list_with_http_info(opts)

```ruby
begin
  # Read a 'vrf.Vrf' resource.
  data, status_code, headers = api_instance.get_vrf_vrf_list_with_http_info(opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <VrfVrfResponse>
rescue IntersightClient::ApiError => e
  puts "Error when calling VrfApi->get_vrf_vrf_list_with_http_info: #{e}"
end
```
...
#### Using the patch_vrf_vrf_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<VrfVrf>, Integer, Hash)> patch_vrf_vrf_with_http_info(moid, vrf_vrf, opts)

```ruby
begin
  # Update a 'vrf.Vrf' resource.
  data, status_code, headers = api_instance.patch_vrf_vrf_with_http_info(moid, vrf_vrf, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <VrfVrf>
rescue IntersightClient::ApiError => e
  puts "Error when calling VrfApi->patch_vrf_vrf_with_http_info: #{e}"
end
```
...
> <VrfVrf> update_vrf_vrf(moid, vrf_vrf, opts)
