...
begin
  # Read a 'ether.HostPort' resource.
  result = api_instance.get_ether_host_port_list(opts)
  p result
rescue IntersightClient::ApiError => e
  puts "Error when calling EtherApi->get_ether_host_port_list: #{e}"
end
```

#### Using the get_ether_host_port_list_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<EtherHostPortResponse>, Integer, Hash)> get_ether_host_port_list_with_http_info(opts)

```ruby
begin
  # Read a 'ether.HostPort' resource.
  data, status_code, headers = api_instance.get_ether_host_port_list_with_http_info(opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <EtherHostPortResponse>
rescue IntersightClient::ApiError => e
  puts "Error when calling EtherApi->get_ether_host_port_list_with_http_info: #{e}"
end
```
...
#### Using the get_ether_network_port_by_moid_with_http_info variant
...
#### Using the get_ether_network_port_list_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<EtherNetworkPortResponse>, Integer, Hash)> get_ether_network_port_list_with_http_info(opts)

```ruby
begin
  # Read a 'ether.NetworkPort' resource.
  data, status_code, headers = api_instance.get_ether_network_port_list_with_http_info(opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <EtherNetworkPortResponse>
rescue IntersightClient::ApiError => e
  puts "Error when calling EtherApi->get_ether_network_port_list_with_http_info: #{e}"
end
```
...
> <EtherPortChannel> get_ether_port_channel_by_moid(moid)
...
begin
  # Read a 'ether.PortChannel' resource.
  result = api_instance.get_ether_port_channel_list(opts)
  p result
rescue IntersightClient::ApiError => e
  puts "Error when calling EtherApi->get_ether_port_channel_list: #{e}"
end
```

#### Using the get_ether_port_channel_list_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<EtherPortChannelResponse>, Integer, Hash)> get_ether_port_channel_list_with_http_info(opts)

```ruby
begin
  # Read a 'ether.PortChannel' resource.
  data, status_code, headers = api_instance.get_ether_port_channel_list_with_http_info(opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <EtherPortChannelResponse>
rescue IntersightClient::ApiError => e
  puts "Error when calling EtherApi->get_ether_port_channel_list_with_http_info: #{e}"
end
```
...
> <Array(<EtherNetworkPort>, Integer, Hash)> patch_ether_network_port_with_http_info(moid, ether_network_port, opts)
...
begin
  # Update a 'ether.NetworkPort' resource.
  data, status_code, headers = api_instance.update_ether_network_port_with_http_info(moid, ether_network_port, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <EtherNetworkPort>
rescue IntersightClient::ApiError => e
  puts "Error when calling EtherApi->update_ether_network_port_with_http_info: #{e}"
end
```
...
> <EtherPhysicalPort> update_ether_physical_port(moid, ether_physical_port, opts)
