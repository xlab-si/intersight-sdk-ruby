...
#### Using the get_vmrc_console_list_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<VmrcConsoleResponse>, Integer, Hash)> get_vmrc_console_list_with_http_info(opts)

```ruby
begin
  # Read a 'vmrc.Console' resource.
  data, status_code, headers = api_instance.get_vmrc_console_list_with_http_info(opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <VmrcConsoleResponse>
rescue IntersightClient::ApiError => e
  puts "Error when calling VmrcApi->get_vmrc_console_list_with_http_info: #{e}"
end
```
...
#### Using the patch_vmrc_console_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<VmrcConsole>, Integer, Hash)> patch_vmrc_console_with_http_info(moid, vmrc_console, opts)

```ruby
begin
  # Update a 'vmrc.Console' resource.
  data, status_code, headers = api_instance.patch_vmrc_console_with_http_info(moid, vmrc_console, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <VmrcConsole>
rescue IntersightClient::ApiError => e
  puts "Error when calling VmrcApi->patch_vmrc_console_with_http_info: #{e}"
end
```
...
> <VmrcConsole> update_vmrc_console(moid, vmrc_console, opts)
