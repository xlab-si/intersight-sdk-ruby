...
# Unit tests for IntersightClient::HyperflexSysConfigPolicyAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IntersightClient::HyperflexSysConfigPolicyAllOf do
  let(:instance) { IntersightClient::HyperflexSysConfigPolicyAllOf.new }

  describe 'test an instance of HyperflexSysConfigPolicyAllOf' do
    it 'should create an instance of HyperflexSysConfigPolicyAllOf' do
      expect(instance).to be_instance_of(IntersightClient::HyperflexSysConfigPolicyAllOf)
    end
  end
  describe 'test attribute "class_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["hyperflex.SysConfigPolicy"])
