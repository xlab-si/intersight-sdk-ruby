...
# Unit tests for IntersightClient::HyperflexSysConfigPolicy
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IntersightClient::HyperflexSysConfigPolicy do
  let(:instance) { IntersightClient::HyperflexSysConfigPolicy.new }

  describe 'test an instance of HyperflexSysConfigPolicy' do
    it 'should create an instance of HyperflexSysConfigPolicy' do
      expect(instance).to be_instance_of(IntersightClient::HyperflexSysConfigPolicy)
    end
  end
