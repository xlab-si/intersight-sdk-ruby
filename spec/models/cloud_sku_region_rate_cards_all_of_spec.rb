...
# Unit tests for IntersightClient::CloudSkuRegionRateCardsAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IntersightClient::CloudSkuRegionRateCardsAllOf do
  let(:instance) { IntersightClient::CloudSkuRegionRateCardsAllOf.new }

  describe 'test an instance of CloudSkuRegionRateCardsAllOf' do
    it 'should create an instance of CloudSkuRegionRateCardsAllOf' do
      expect(instance).to be_instance_of(IntersightClient::CloudSkuRegionRateCardsAllOf)
    end
  end
  describe 'test attribute "class_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["cloud.SkuRegionRateCards"])
  ...
  describe 'test attribute "sku_name"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
