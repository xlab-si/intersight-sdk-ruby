...
# Unit tests for IntersightClient::AssetTargetAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IntersightClient::AssetTargetAllOf do
  let(:instance) { IntersightClient::AssetTargetAllOf.new }

  describe 'test an instance of AssetTargetAllOf' do
    it 'should create an instance of AssetTargetAllOf' do
      expect(instance).to be_instance_of(IntersightClient::AssetTargetAllOf)
    end
  end
  describe 'test attribute "class_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["asset.Target"])
  ...
  describe 'test attribute "external_ip_address"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "management_location"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["Unknown", "Intersight", "IntersightAssist", "DeviceConnector"])
      # validator.allowable_values.each do |value|
      #   expect { instance.management_location = value }.not_to raise_error
      # end
    end
  end
  ...
  describe 'test attribute "status_error_reason"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "assist"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
