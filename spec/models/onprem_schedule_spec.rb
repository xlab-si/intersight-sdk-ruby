...
# Unit tests for IntersightClient::OnpremSchedule
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IntersightClient::OnpremSchedule do
  let(:instance) { IntersightClient::OnpremSchedule.new }

  describe 'test an instance of OnpremSchedule' do
    it 'should create an instance of OnpremSchedule' do
      expect(instance).to be_instance_of(IntersightClient::OnpremSchedule)
    end
  end
