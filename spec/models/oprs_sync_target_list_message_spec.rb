...
# Unit tests for IntersightClient::OprsSyncTargetListMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IntersightClient::OprsSyncTargetListMessage do
  let(:instance) { IntersightClient::OprsSyncTargetListMessage.new }

  describe 'test an instance of OprsSyncTargetListMessage' do
    it 'should create an instance of OprsSyncTargetListMessage' do
      expect(instance).to be_instance_of(IntersightClient::OprsSyncTargetListMessage)
    end
  end
