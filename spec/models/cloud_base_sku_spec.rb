...
# Unit tests for IntersightClient::CloudBaseSku
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IntersightClient::CloudBaseSku do
  let(:instance) { IntersightClient::CloudBaseSku.new }

  describe 'test an instance of CloudBaseSku' do
    it 'should create an instance of CloudBaseSku' do
      expect(instance).to be_instance_of(IntersightClient::CloudBaseSku)
    end
  end
