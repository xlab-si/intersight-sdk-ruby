...
# Unit tests for IntersightClient::HclProduct
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IntersightClient::HclProduct do
  let(:instance) { IntersightClient::HclProduct.new }

  describe 'test an instance of HclProduct' do
    it 'should create an instance of HclProduct' do
      expect(instance).to be_instance_of(IntersightClient::HclProduct)
    end
  end
