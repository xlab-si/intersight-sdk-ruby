...
# Unit tests for IntersightClient::KubernetesSysConfigPolicyAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IntersightClient::KubernetesSysConfigPolicyAllOf do
  let(:instance) { IntersightClient::KubernetesSysConfigPolicyAllOf.new }

  describe 'test an instance of KubernetesSysConfigPolicyAllOf' do
    it 'should create an instance of KubernetesSysConfigPolicyAllOf' do
      expect(instance).to be_instance_of(IntersightClient::KubernetesSysConfigPolicyAllOf)
    end
  end
  describe 'test attribute "class_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["kubernetes.SysConfigPolicy"])
  ...
  describe 'test attribute "dns_domain_name"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
