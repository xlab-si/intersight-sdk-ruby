...
# Unit tests for IntersightClient::IamEndPointPrivilege
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IntersightClient::IamEndPointPrivilege do
  let(:instance) { IntersightClient::IamEndPointPrivilege.new }

  describe 'test an instance of IamEndPointPrivilege' do
    it 'should create an instance of IamEndPointPrivilege' do
      expect(instance).to be_instance_of(IntersightClient::IamEndPointPrivilege)
    end
  end
