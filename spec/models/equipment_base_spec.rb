...
# Unit tests for IntersightClient::EquipmentBase
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IntersightClient::EquipmentBase do
  let(:instance) { IntersightClient::EquipmentBase.new }

  describe 'test an instance of EquipmentBase' do
    it 'should create an instance of EquipmentBase' do
      expect(instance).to be_instance_of(IntersightClient::EquipmentBase)
    end
  end
