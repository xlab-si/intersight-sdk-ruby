...
# Unit tests for IntersightClient::IamEndPointRole
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IntersightClient::IamEndPointRole do
  let(:instance) { IntersightClient::IamEndPointRole.new }

  describe 'test an instance of IamEndPointRole' do
    it 'should create an instance of IamEndPointRole' do
      expect(instance).to be_instance_of(IntersightClient::IamEndPointRole)
    end
  end
