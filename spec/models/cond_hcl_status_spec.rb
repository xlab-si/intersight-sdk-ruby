...
# Unit tests for IntersightClient::CondHclStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IntersightClient::CondHclStatus do
  let(:instance) { IntersightClient::CondHclStatus.new }

  describe 'test an instance of CondHclStatus' do
    it 'should create an instance of CondHclStatus' do
      expect(instance).to be_instance_of(IntersightClient::CondHclStatus)
    end
  end
