...
# Unit tests for IntersightClient::WorkflowErrorResponseHandlerAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IntersightClient::WorkflowErrorResponseHandlerAllOf do
  let(:instance) { IntersightClient::WorkflowErrorResponseHandlerAllOf.new }

  describe 'test an instance of WorkflowErrorResponseHandlerAllOf' do
    it 'should create an instance of WorkflowErrorResponseHandlerAllOf' do
      expect(instance).to be_instance_of(IntersightClient::WorkflowErrorResponseHandlerAllOf)
    end
  end
  describe 'test attribute "class_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["workflow.ErrorResponseHandler"])
