...
# Unit tests for IntersightClient::BiosPolicyAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IntersightClient::BiosPolicyAllOf do
  let(:instance) { IntersightClient::BiosPolicyAllOf.new }

  describe 'test an instance of BiosPolicyAllOf' do
    it 'should create an instance of BiosPolicyAllOf' do
      expect(instance).to be_instance_of(IntersightClient::BiosPolicyAllOf)
    end
  end
