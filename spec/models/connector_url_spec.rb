...
# Unit tests for IntersightClient::ConnectorUrl
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IntersightClient::ConnectorUrl do
  let(:instance) { IntersightClient::ConnectorUrl.new }

  describe 'test an instance of ConnectorUrl' do
    it 'should create an instance of ConnectorUrl' do
      expect(instance).to be_instance_of(IntersightClient::ConnectorUrl)
    end
  end
