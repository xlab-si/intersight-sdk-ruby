...
# Unit tests for IntersightClient::KubernetesSysConfigPolicy
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IntersightClient::KubernetesSysConfigPolicy do
  let(:instance) { IntersightClient::KubernetesSysConfigPolicy.new }

  describe 'test an instance of KubernetesSysConfigPolicy' do
    it 'should create an instance of KubernetesSysConfigPolicy' do
      expect(instance).to be_instance_of(IntersightClient::KubernetesSysConfigPolicy)
    end
  end
