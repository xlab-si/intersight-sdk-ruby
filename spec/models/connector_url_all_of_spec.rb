...
# Unit tests for IntersightClient::ConnectorUrlAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IntersightClient::ConnectorUrlAllOf do
  let(:instance) { IntersightClient::ConnectorUrlAllOf.new }

  describe 'test an instance of ConnectorUrlAllOf' do
    it 'should create an instance of ConnectorUrlAllOf' do
      expect(instance).to be_instance_of(IntersightClient::ConnectorUrlAllOf)
    end
  end
  describe 'test attribute "class_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["connector.Url"])
