...
# Unit tests for IntersightClient::InventoryBase
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IntersightClient::InventoryBase do
  let(:instance) { IntersightClient::InventoryBase.new }

  describe 'test an instance of InventoryBase' do
    it 'should create an instance of InventoryBase' do
      expect(instance).to be_instance_of(IntersightClient::InventoryBase)
    end
  end
