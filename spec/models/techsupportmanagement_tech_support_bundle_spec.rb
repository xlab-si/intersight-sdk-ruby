...
# Unit tests for IntersightClient::TechsupportmanagementTechSupportBundle
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IntersightClient::TechsupportmanagementTechSupportBundle do
  let(:instance) { IntersightClient::TechsupportmanagementTechSupportBundle.new }

  describe 'test an instance of TechsupportmanagementTechSupportBundle' do
    it 'should create an instance of TechsupportmanagementTechSupportBundle' do
      expect(instance).to be_instance_of(IntersightClient::TechsupportmanagementTechSupportBundle)
    end
  end
