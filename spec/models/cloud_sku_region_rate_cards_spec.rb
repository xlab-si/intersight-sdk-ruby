...
# Unit tests for IntersightClient::CloudSkuRegionRateCards
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IntersightClient::CloudSkuRegionRateCards do
  let(:instance) { IntersightClient::CloudSkuRegionRateCards.new }

  describe 'test an instance of CloudSkuRegionRateCards' do
    it 'should create an instance of CloudSkuRegionRateCards' do
      expect(instance).to be_instance_of(IntersightClient::CloudSkuRegionRateCards)
    end
  end
