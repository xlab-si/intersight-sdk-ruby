...
# Unit tests for IntersightClient::TechsupportmanagementTechSupportBundleAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IntersightClient::TechsupportmanagementTechSupportBundleAllOf do
  let(:instance) { IntersightClient::TechsupportmanagementTechSupportBundleAllOf.new }

  describe 'test an instance of TechsupportmanagementTechSupportBundleAllOf' do
    it 'should create an instance of TechsupportmanagementTechSupportBundleAllOf' do
      expect(instance).to be_instance_of(IntersightClient::TechsupportmanagementTechSupportBundleAllOf)
    end
  end
  describe 'test attribute "class_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["techsupportmanagement.TechSupportBundle"])
  ...
  describe 'test attribute "platform_param"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "tech_support_status"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
