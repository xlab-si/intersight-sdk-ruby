...
# Unit tests for IntersightClient::CloudBaseSkuAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IntersightClient::CloudBaseSkuAllOf do
  let(:instance) { IntersightClient::CloudBaseSkuAllOf.new }

  describe 'test an instance of CloudBaseSkuAllOf' do
    it 'should create an instance of CloudBaseSkuAllOf' do
      expect(instance).to be_instance_of(IntersightClient::CloudBaseSkuAllOf)
    end
  end
  describe 'test attribute "class_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["cloud.SkuContainerType", "cloud.SkuDatabaseType", "cloud.SkuInstanceType", "cloud.SkuNetworkType", "cloud.SkuVolumeType"])
  ...
  describe 'test attribute "is_auto_discovered"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "service_category"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["Compute", "Storage", "Database", "Network"])
      # validator.allowable_values.each do |value|
  ...
  describe 'test attribute "service_family"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
