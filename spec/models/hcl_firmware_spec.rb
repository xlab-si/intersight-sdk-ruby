...
# Unit tests for IntersightClient::HclFirmware
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IntersightClient::HclFirmware do
  let(:instance) { IntersightClient::HclFirmware.new }

  describe 'test an instance of HclFirmware' do
    it 'should create an instance of HclFirmware' do
      expect(instance).to be_instance_of(IntersightClient::HclFirmware)
    end
  end
