...
# Unit tests for IntersightClient::PolicyAbstractPolicy
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IntersightClient::PolicyAbstractPolicy do
  let(:instance) { IntersightClient::PolicyAbstractPolicy.new }

  describe 'test an instance of PolicyAbstractPolicy' do
    it 'should create an instance of PolicyAbstractPolicy' do
      expect(instance).to be_instance_of(IntersightClient::PolicyAbstractPolicy)
    end
  end
