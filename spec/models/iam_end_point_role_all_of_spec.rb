...
# Unit tests for IntersightClient::IamEndPointRoleAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IntersightClient::IamEndPointRoleAllOf do
  let(:instance) { IntersightClient::IamEndPointRoleAllOf.new }

  describe 'test an instance of IamEndPointRoleAllOf' do
    it 'should create an instance of IamEndPointRoleAllOf' do
      expect(instance).to be_instance_of(IntersightClient::IamEndPointRoleAllOf)
    end
  end
  describe 'test attribute "class_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["iam.EndPointRole"])
  ...
  describe 'test attribute "end_point_privileges"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
