...
# Unit tests for IntersightClient::ApplianceSystemInfoAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IntersightClient::ApplianceSystemInfoAllOf do
  let(:instance) { IntersightClient::ApplianceSystemInfoAllOf.new }

  describe 'test an instance of ApplianceSystemInfoAllOf' do
    it 'should create an instance of ApplianceSystemInfoAllOf' do
      expect(instance).to be_instance_of(IntersightClient::ApplianceSystemInfoAllOf)
    end
  end
