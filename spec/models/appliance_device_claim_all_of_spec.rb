...
# Unit tests for IntersightClient::ApplianceDeviceClaimAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IntersightClient::ApplianceDeviceClaimAllOf do
  let(:instance) { IntersightClient::ApplianceDeviceClaimAllOf.new }

  describe 'test an instance of ApplianceDeviceClaimAllOf' do
    it 'should create an instance of ApplianceDeviceClaimAllOf' do
      expect(instance).to be_instance_of(IntersightClient::ApplianceDeviceClaimAllOf)
    end
  end
  describe 'test attribute "class_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["appliance.DeviceClaim"])
  ...
  describe 'test attribute "is_renew"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "status"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["started", "failed", "completed"])
      # validator.allowable_values.each do |value|
