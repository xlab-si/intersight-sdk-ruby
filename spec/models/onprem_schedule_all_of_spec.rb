...
# Unit tests for IntersightClient::OnpremScheduleAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IntersightClient::OnpremScheduleAllOf do
  let(:instance) { IntersightClient::OnpremScheduleAllOf.new }

  describe 'test an instance of OnpremScheduleAllOf' do
    it 'should create an instance of OnpremScheduleAllOf' do
      expect(instance).to be_instance_of(IntersightClient::OnpremScheduleAllOf)
    end
  end
  describe 'test attribute "class_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["onprem.Schedule"])
  ...
  describe 'test attribute "month_of_year"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
