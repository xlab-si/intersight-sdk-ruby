...
# Unit tests for IntersightClient::NtpPolicy
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IntersightClient::NtpPolicy do
  let(:instance) { IntersightClient::NtpPolicy.new }

  describe 'test an instance of NtpPolicy' do
    it 'should create an instance of NtpPolicy' do
      expect(instance).to be_instance_of(IntersightClient::NtpPolicy)
    end
  end
