...
# Unit tests for IntersightClient::CloudRegions
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IntersightClient::CloudRegions do
  let(:instance) { IntersightClient::CloudRegions.new }

  describe 'test an instance of CloudRegions' do
    it 'should create an instance of CloudRegions' do
      expect(instance).to be_instance_of(IntersightClient::CloudRegions)
    end
  end
