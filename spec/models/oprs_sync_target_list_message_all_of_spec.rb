...
# Unit tests for IntersightClient::OprsSyncTargetListMessageAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IntersightClient::OprsSyncTargetListMessageAllOf do
  let(:instance) { IntersightClient::OprsSyncTargetListMessageAllOf.new }

  describe 'test an instance of OprsSyncTargetListMessageAllOf' do
    it 'should create an instance of OprsSyncTargetListMessageAllOf' do
      expect(instance).to be_instance_of(IntersightClient::OprsSyncTargetListMessageAllOf)
    end
  end
  describe 'test attribute "class_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["oprs.SyncTargetListMessage"])
  ...
  describe 'test attribute "assist_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
