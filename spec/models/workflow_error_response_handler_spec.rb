...
# Unit tests for IntersightClient::WorkflowErrorResponseHandler
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IntersightClient::WorkflowErrorResponseHandler do
  let(:instance) { IntersightClient::WorkflowErrorResponseHandler.new }

  describe 'test an instance of WorkflowErrorResponseHandler' do
    it 'should create an instance of WorkflowErrorResponseHandler' do
      expect(instance).to be_instance_of(IntersightClient::WorkflowErrorResponseHandler)
    end
  end
