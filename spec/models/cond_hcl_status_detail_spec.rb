...
# Unit tests for IntersightClient::CondHclStatusDetail
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IntersightClient::CondHclStatusDetail do
  let(:instance) { IntersightClient::CondHclStatusDetail.new }

  describe 'test an instance of CondHclStatusDetail' do
    it 'should create an instance of CondHclStatusDetail' do
      expect(instance).to be_instance_of(IntersightClient::CondHclStatusDetail)
    end
  end
