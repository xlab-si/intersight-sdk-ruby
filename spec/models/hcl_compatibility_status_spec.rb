...
# Unit tests for IntersightClient::HclCompatibilityStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IntersightClient::HclCompatibilityStatus do
  let(:instance) { IntersightClient::HclCompatibilityStatus.new }

  describe 'test an instance of HclCompatibilityStatus' do
    it 'should create an instance of HclCompatibilityStatus' do
      expect(instance).to be_instance_of(IntersightClient::HclCompatibilityStatus)
    end
  end
