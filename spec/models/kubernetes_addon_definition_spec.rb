...
# Unit tests for IntersightClient::KubernetesAddonDefinition
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IntersightClient::KubernetesAddonDefinition do
  let(:instance) { IntersightClient::KubernetesAddonDefinition.new }

  describe 'test an instance of KubernetesAddonDefinition' do
    it 'should create an instance of KubernetesAddonDefinition' do
      expect(instance).to be_instance_of(IntersightClient::KubernetesAddonDefinition)
    end
  end
