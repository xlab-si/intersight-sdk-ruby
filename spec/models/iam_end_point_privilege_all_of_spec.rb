...
# Unit tests for IntersightClient::IamEndPointPrivilegeAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IntersightClient::IamEndPointPrivilegeAllOf do
  let(:instance) { IntersightClient::IamEndPointPrivilegeAllOf.new }

  describe 'test an instance of IamEndPointPrivilegeAllOf' do
    it 'should create an instance of IamEndPointPrivilegeAllOf' do
      expect(instance).to be_instance_of(IntersightClient::IamEndPointPrivilegeAllOf)
    end
  end
  describe 'test attribute "class_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["iam.EndPointPrivilege"])
