...
# Unit tests for IntersightClient::CloudRegionsAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IntersightClient::CloudRegionsAllOf do
  let(:instance) { IntersightClient::CloudRegionsAllOf.new }

  describe 'test an instance of CloudRegionsAllOf' do
    it 'should create an instance of CloudRegionsAllOf' do
      expect(instance).to be_instance_of(IntersightClient::CloudRegionsAllOf)
    end
  end
  describe 'test attribute "class_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["cloud.Regions"])
  ...
  describe 'test attribute "default_zone"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "is_billing_only"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "region_end_point"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
