...
# Unit tests for IntersightClient::ApplianceDeviceClaim
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IntersightClient::ApplianceDeviceClaim do
  let(:instance) { IntersightClient::ApplianceDeviceClaim.new }

  describe 'test an instance of ApplianceDeviceClaim' do
    it 'should create an instance of ApplianceDeviceClaim' do
      expect(instance).to be_instance_of(IntersightClient::ApplianceDeviceClaim)
    end
  end
