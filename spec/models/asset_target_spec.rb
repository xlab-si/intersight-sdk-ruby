...
# Unit tests for IntersightClient::AssetTarget
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IntersightClient::AssetTarget do
  let(:instance) { IntersightClient::AssetTarget.new }

  describe 'test an instance of AssetTarget' do
    it 'should create an instance of AssetTarget' do
      expect(instance).to be_instance_of(IntersightClient::AssetTarget)
    end
  end
