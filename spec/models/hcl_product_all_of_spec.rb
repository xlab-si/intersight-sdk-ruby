...
# Unit tests for IntersightClient::HclProductAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IntersightClient::HclProductAllOf do
  let(:instance) { IntersightClient::HclProductAllOf.new }

  describe 'test an instance of HclProductAllOf' do
    it 'should create an instance of HclProductAllOf' do
      expect(instance).to be_instance_of(IntersightClient::HclProductAllOf)
    end
  end
  describe 'test attribute "class_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["hcl.Product"])
  ...
  describe 'test attribute "driver_names"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "firmwares"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
