...
# Unit tests for IntersightClient::UcsdApi
...
describe 'UcsdApi' do
  ...
  describe 'test an instance of UcsdApi' do
    it 'should create an instance of UcsdApi' do
      expect(@api_instance).to be_instance_of(IntersightClient::UcsdApi)
    end
  end

  # unit tests for delete_ucsd_backup_info
  # Delete a &#39;ucsd.BackupInfo&#39; resource.
  # @param moid The unique Moid identifier of a resource instance.
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'delete_ucsd_backup_info test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_ucsd_backup_info_by_moid
  # Read a &#39;ucsd.BackupInfo&#39; resource.
  # @param moid The unique Moid identifier of a resource instance.
  # @param [Hash] opts the optional parameters
  # @return [UcsdBackupInfo]
  describe 'get_ucsd_backup_info_by_moid test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_ucsd_backup_info_list
  # Read a &#39;ucsd.BackupInfo&#39; resource.
  # @param [Hash] opts the optional parameters
  ...
  describe 'get_ucsd_backup_info_list test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
