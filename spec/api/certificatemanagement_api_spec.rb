...
# Unit tests for IntersightClient::CertificatemanagementApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'CertificatemanagementApi' do
  before do
  ...
  describe 'test an instance of CertificatemanagementApi' do
    it 'should create an instance of CertificatemanagementApi' do
      expect(@api_instance).to be_instance_of(IntersightClient::CertificatemanagementApi)
    end
  end

  # unit tests for create_certificatemanagement_policy
  # Create a &#39;certificatemanagement.Policy&#39; resource.
  # @param certificatemanagement_policy The &#39;certificatemanagement.Policy&#39; resource to create.
  ...
  describe 'create_certificatemanagement_policy test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for delete_certificatemanagement_policy
  # Delete a &#39;certificatemanagement.Policy&#39; resource.
  # @param moid The unique Moid identifier of a resource instance.
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'delete_certificatemanagement_policy test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_certificatemanagement_policy_by_moid
  # Read a &#39;certificatemanagement.Policy&#39; resource.
  # @param moid The unique Moid identifier of a resource instance.
  # @param [Hash] opts the optional parameters
  # @return [CertificatemanagementPolicy]
  describe 'get_certificatemanagement_policy_by_moid test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_certificatemanagement_policy_list
  # Read a &#39;certificatemanagement.Policy&#39; resource.
  # @param [Hash] opts the optional parameters
  ...
  describe 'get_certificatemanagement_policy_list test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for patch_certificatemanagement_policy
  # Update a &#39;certificatemanagement.Policy&#39; resource.
  # @param moid The unique Moid identifier of a resource instance.
  # @param certificatemanagement_policy The &#39;certificatemanagement.Policy&#39; resource to update.
  # @param [Hash] opts the optional parameters
  # @option opts [String] :if_match For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request.
  # @return [CertificatemanagementPolicy]
  describe 'patch_certificatemanagement_policy test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for update_certificatemanagement_policy
  # Update a &#39;certificatemanagement.Policy&#39; resource.
  # @param moid The unique Moid identifier of a resource instance.
  # @param certificatemanagement_policy The &#39;certificatemanagement.Policy&#39; resource to update.
  # @param [Hash] opts the optional parameters
  # @option opts [String] :if_match For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request.
  # @return [CertificatemanagementPolicy]
  describe 'update_certificatemanagement_policy test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
