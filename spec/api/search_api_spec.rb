...
# Unit tests for IntersightClient::SearchApi
...
describe 'SearchApi' do
  ...
  describe 'test an instance of SearchApi' do
    it 'should create an instance of SearchApi' do
      expect(@api_instance).to be_instance_of(IntersightClient::SearchApi)
    end
  end

  # unit tests for create_search_suggest_item
  # Create a &#39;search.SuggestItem&#39; resource.
  # @param search_suggest_item The &#39;search.SuggestItem&#39; resource to create.
  ...
  describe 'create_search_suggest_item test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_search_search_item_by_moid
  # Read a &#39;search.SearchItem&#39; resource.
  # @param moid The unique Moid identifier of a resource instance.
  # @param [Hash] opts the optional parameters
  # @return [SearchSearchItem]
  describe 'get_search_search_item_by_moid test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_search_search_item_list
  # Read a &#39;search.SearchItem&#39; resource.
  # @param [Hash] opts the optional parameters
  ...
  describe 'get_search_search_item_list test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_search_tag_item_by_moid
  # Read a &#39;search.TagItem&#39; resource.
  # @param moid The unique Moid identifier of a resource instance.
  # @param [Hash] opts the optional parameters
  # @return [SearchTagItem]
  describe 'get_search_tag_item_by_moid test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_search_tag_item_list
  # Read a &#39;search.TagItem&#39; resource.
  # @param [Hash] opts the optional parameters
  # @option opts [String] :filter Filter criteria for the resources to return. A URI with a $filter query option identifies a subset of the entries from the Collection of Entries. The subset is determined by selecting only the Entries that satisfy the predicate expression specified by the $filter option. The expression language that is used in $filter queries supports references to properties and literals. The literal values can be strings enclosed in single quotes, numbers and boolean values (true or false).
  # @option opts [String] :orderby Determines what properties are used to sort the collection of resources.
  ...
  describe 'get_search_tag_item_list test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
