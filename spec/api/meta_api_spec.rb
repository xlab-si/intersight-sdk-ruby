...
# Unit tests for IntersightClient::MetaApi
...
describe 'MetaApi' do
  ...
  describe 'test an instance of MetaApi' do
    it 'should create an instance of MetaApi' do
      expect(@api_instance).to be_instance_of(IntersightClient::MetaApi)
    end
  end

  # unit tests for delete_meta_definition
  # Delete a &#39;meta.Definition&#39; resource.
  # @param moid The unique Moid identifier of a resource instance.
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'delete_meta_definition test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_meta_definition_by_moid
  # Read a &#39;meta.Definition&#39; resource.
  # @param moid The unique Moid identifier of a resource instance.
  # @param [Hash] opts the optional parameters
  # @return [MetaDefinition]
  describe 'get_meta_definition_by_moid test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_meta_definition_list
  # Read a &#39;meta.Definition&#39; resource.
  # @param [Hash] opts the optional parameters
  ...
  describe 'get_meta_definition_list test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
