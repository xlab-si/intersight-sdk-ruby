...
# Unit tests for IntersightClient::ConnectorpackApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ConnectorpackApi' do
  before do
  ...
  describe 'test an instance of ConnectorpackApi' do
    it 'should create an instance of ConnectorpackApi' do
      expect(@api_instance).to be_instance_of(IntersightClient::ConnectorpackApi)
    end
  end

  # unit tests for create_connectorpack_connector_pack_upgrade
  # Create a &#39;connectorpack.ConnectorPackUpgrade&#39; resource.
  # @param connectorpack_connector_pack_upgrade The &#39;connectorpack.ConnectorPackUpgrade&#39; resource to create.
  ...
  describe 'create_connectorpack_connector_pack_upgrade test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for delete_connectorpack_connector_pack_upgrade
  # Delete a &#39;connectorpack.ConnectorPackUpgrade&#39; resource.
  # @param moid The unique Moid identifier of a resource instance.
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'delete_connectorpack_connector_pack_upgrade test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_connectorpack_connector_pack_upgrade_by_moid
  # Read a &#39;connectorpack.ConnectorPackUpgrade&#39; resource.
  # @param moid The unique Moid identifier of a resource instance.
  # @param [Hash] opts the optional parameters
  # @return [ConnectorpackConnectorPackUpgrade]
  describe 'get_connectorpack_connector_pack_upgrade_by_moid test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_connectorpack_connector_pack_upgrade_list
  # Read a &#39;connectorpack.ConnectorPackUpgrade&#39; resource.
  # @param [Hash] opts the optional parameters
  ...
  describe 'get_connectorpack_connector_pack_upgrade_list test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_connectorpack_upgrade_impact_by_moid
  # Read a &#39;connectorpack.UpgradeImpact&#39; resource.
  # @param moid The unique Moid identifier of a resource instance.
  # @param [Hash] opts the optional parameters
  # @return [ConnectorpackUpgradeImpact]
  describe 'get_connectorpack_upgrade_impact_by_moid test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_connectorpack_upgrade_impact_list
  # Read a &#39;connectorpack.UpgradeImpact&#39; resource.
  # @param [Hash] opts the optional parameters
  # @option opts [String] :filter Filter criteria for the resources to return. A URI with a $filter query option identifies a subset of the entries from the Collection of Entries. The subset is determined by selecting only the Entries that satisfy the predicate expression specified by the $filter option. The expression language that is used in $filter queries supports references to properties and literals. The literal values can be strings enclosed in single quotes, numbers and boolean values (true or false).
  # @option opts [String] :orderby Determines what properties are used to sort the collection of resources.
  ...
  describe 'get_connectorpack_upgrade_impact_list test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
