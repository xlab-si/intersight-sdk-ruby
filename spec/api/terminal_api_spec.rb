...
# Unit tests for IntersightClient::TerminalApi
...
describe 'TerminalApi' do
  ...
  describe 'test an instance of TerminalApi' do
    it 'should create an instance of TerminalApi' do
      expect(@api_instance).to be_instance_of(IntersightClient::TerminalApi)
    end
  end

  # unit tests for get_terminal_audit_log_by_moid
  # Read a &#39;terminal.AuditLog&#39; resource.
  # @param moid The unique Moid identifier of a resource instance.
  # @param [Hash] opts the optional parameters
  # @return [TerminalAuditLog]
  describe 'get_terminal_audit_log_by_moid test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_terminal_audit_log_list
  # Read a &#39;terminal.AuditLog&#39; resource.
  # @param [Hash] opts the optional parameters
  ...
  describe 'get_terminal_audit_log_list test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
