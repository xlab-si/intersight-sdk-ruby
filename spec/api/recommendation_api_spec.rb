...
# Unit tests for IntersightClient::RecommendationApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'RecommendationApi' do
  before do
  ...
  describe 'test an instance of RecommendationApi' do
    it 'should create an instance of RecommendationApi' do
      expect(@api_instance).to be_instance_of(IntersightClient::RecommendationApi)
    end
  end

  # unit tests for get_recommendation_capacity_runway_by_moid
  # Read a &#39;recommendation.CapacityRunway&#39; resource.
  # @param moid The unique Moid identifier of a resource instance.
  # @param [Hash] opts the optional parameters
  # @return [RecommendationCapacityRunway]
  describe 'get_recommendation_capacity_runway_by_moid test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_recommendation_capacity_runway_list
  # Read a &#39;recommendation.CapacityRunway&#39; resource.
  # @param [Hash] opts the optional parameters
  ...
  describe 'get_recommendation_capacity_runway_list test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_recommendation_physical_item_by_moid
  # Read a &#39;recommendation.PhysicalItem&#39; resource.
  # @param moid The unique Moid identifier of a resource instance.
  # @param [Hash] opts the optional parameters
  # @return [RecommendationPhysicalItem]
  describe 'get_recommendation_physical_item_by_moid test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_recommendation_physical_item_list
  # Read a &#39;recommendation.PhysicalItem&#39; resource.
  # @param [Hash] opts the optional parameters
  # @option opts [String] :filter Filter criteria for the resources to return. A URI with a $filter query option identifies a subset of the entries from the Collection of Entries. The subset is determined by selecting only the Entries that satisfy the predicate expression specified by the $filter option. The expression language that is used in $filter queries supports references to properties and literals. The literal values can be strings enclosed in single quotes, numbers and boolean values (true or false).
  # @option opts [String] :orderby Determines what properties are used to sort the collection of resources.
  ...
  describe 'get_recommendation_physical_item_list test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
