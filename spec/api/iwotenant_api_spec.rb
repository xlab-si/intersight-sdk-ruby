...
# Unit tests for IntersightClient::IwotenantApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'IwotenantApi' do
  before do
  ...
  describe 'test an instance of IwotenantApi' do
    it 'should create an instance of IwotenantApi' do
      expect(@api_instance).to be_instance_of(IntersightClient::IwotenantApi)
    end
  end

  # unit tests for get_iwotenant_tenant_status_by_moid
  # Read a &#39;iwotenant.TenantStatus&#39; resource.
  # @param moid The unique Moid identifier of a resource instance.
  # @param [Hash] opts the optional parameters
  # @return [IwotenantTenantStatus]
  describe 'get_iwotenant_tenant_status_by_moid test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_iwotenant_tenant_status_list
  # Read a &#39;iwotenant.TenantStatus&#39; resource.
  # @param [Hash] opts the optional parameters
  ...
  describe 'get_iwotenant_tenant_status_list test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
